...
return {
  ...
  installer_hash = "a2d4e2dc",
  installer_size_bytes = 123140,
  files = {
    ...
    { path = "installer", size_bytes = 18545, hash = "bf954804" },
    { path = "installer.lua", size_bytes = 33662, hash = "83788c55" },
    { path = "xreactor/installer/installer.lua", size_bytes = 33662, hash = "83788c55" },
    { path = "xreactor/installer/installer_core.lua", size_bytes = 123140, hash = "a2d4e2dc" },
    { path = "xreactor/installer/manifest.lua", size_bytes = 6347, hash = "4e7734cf" },
