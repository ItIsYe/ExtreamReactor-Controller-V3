...
return {
  ...
  files = {
    { path = "xreactor/core/bootstrap.lua", size_bytes = 8777, hash = "e6a523bf" },
    ...
    { path = "xreactor/nodes/rt/main.lua", size_bytes = 92083, hash = "c84a0e51" },
    { path = "xreactor/nodes/reprocessor/config.lua", size_bytes = 3132, hash = "d98073f7" },
    { path = "xreactor/nodes/reprocessor/main.lua", size_bytes = 19635, hash = "06a3ab3b" },
    { path = "xreactor/nodes/water/config.lua", size_bytes = 3230, hash = "791858ea" },
    { path = "xreactor/nodes/water/main.lua", size_bytes = 19313, hash = "6972545a" },
    { path = "xreactor/nodes/fuel/config.lua", size_bytes = 3336, hash = "f879eefe" },
    { path = "xreactor/nodes/fuel/main.lua", size_bytes = 20329, hash = "01194c3b" },
    { path = "xreactor/nodes/energy/config.lua", size_bytes = 4558, hash = "5283fadd" },
    { path = "xreactor/nodes/energy/main.lua", size_bytes = 46836, hash = "54997478" },
    { path = "xreactor/master/config.lua", size_bytes = 4447, hash = "5e7986bc" },
    ...
    { path = "xreactor/master/main.lua", size_bytes = 29832, hash = "393384c5" },
    ...
    { path = "xreactor/master/ui/rt_dashboard.lua", size_bytes = 2319, hash = "157bac63" },
    ...
    { path = "xreactor/master/ui/energy.lua", size_bytes = 3835, hash = "d49d933d" },
    { path = "xreactor/master/ui/multiview.lua", size_bytes = 10085, hash = "dec1dc4e" },
