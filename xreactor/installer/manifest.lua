...
return {
  ...
  installer_hash = "ef1fbcc7",
  installer_size_bytes = 132897,
  files = {
    { path = "xreactor/core/bootstrap.lua", size_bytes = 9115, hash = "d938b424" },
    ...
    { path = "installer", size_bytes = 23244, hash = "7d03192a" },
    { path = "installer.lua", size_bytes = 45433, hash = "80ad806b" },
    { path = "xreactor/installer/installer.lua", size_bytes = 45433, hash = "80ad806b" },
    { path = "xreactor/installer/installer_core.lua", size_bytes = 132897, hash = "ef1fbcc7" },
    { path = "xreactor/installer/manifest.lua", size_bytes = 6436, hash = "7c344b06" },
    { path = "xreactor/installer/release.lua", size_bytes = 217, hash = "cf4498a4" },
    { path = "xreactor/installer/role_files.lua", size_bytes = 961, hash = "48bbdf9a" },
