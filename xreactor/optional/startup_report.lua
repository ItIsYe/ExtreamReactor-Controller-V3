-- xreactor/optional/startup_report.lua
--
-- Optionale Erweiterung: kompakter Startup-Diagnose-Report.
--
...
--
-- Ist rollenuebergreifend nutzbar (RT/ENERGY/FUEL/WATER/REPROCESSOR/MASTER)
