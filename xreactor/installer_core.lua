...
local function ensure_storage_defaults()
  C.BASE_DIR = C.BASE_DIR or "/xreactor"
  C.LOG_DIR = C.LOG_DIR or "/xreactor_logs"
  C.STAGE_DIR = C.STAGE_DIR or "/xreactor_stage"
  C.BACKUP_DIR = C.BACKUP_DIR or "/xreactor_backup"

  C.LOCAL_LOG_DIR = C.LOCAL_LOG_DIR or C.LOG_DIR
  C.LOCAL_STAGING_BASE = C.LOCAL_STAGING_BASE or C.STAGE_DIR
  C.LOCAL_BACKUP_BASE = C.LOCAL_BACKUP_BASE or C.BACKUP_DIR
  C.UPDATE_STAGING_BASE = C.UPDATE_STAGING_BASE or C.STAGE_DIR
  C.BACKUP_BASE = C.BACKUP_BASE or C.BACKUP_DIR

  CONFIG.BASE_DIR = CONFIG.BASE_DIR or C.BASE_DIR
  CONFIG.LOCAL_LOG_DIR = CONFIG.LOCAL_LOG_DIR or C.LOG_DIR
  CONFIG.UPDATE_STAGING_BASE = CONFIG.UPDATE_STAGING_BASE or C.STAGE_DIR
  CONFIG.LOCAL_STAGING_BASE = CONFIG.LOCAL_STAGING_BASE or C.STAGE_DIR
  CONFIG.BACKUP_BASE = CONFIG.BACKUP_BASE or C.BACKUP_DIR
  CONFIG.LOCAL_BACKUP_BASE = CONFIG.LOCAL_BACKUP_BASE or C.BACKUP_DIR
end
