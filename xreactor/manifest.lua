...
return {
  ...
  { path = "installer/auto_update.lua", size_bytes = 5400, hash = "13075422", always=true},
  ...
  { path = "release.lua", size_bytes = 273, hash = "d58c4ebc", always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true},
