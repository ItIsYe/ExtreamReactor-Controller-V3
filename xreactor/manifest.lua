return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 10791, hash = "fe31b315", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 7529, hash = "44e46f17" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 3371, hash = "4158c993" },
      { path = "master/ui/multiview.lua", size_bytes = 4390, hash = "a9924116" },
      { path = "master/ui/overview.lua", size_bytes = 6122, hash = "015a65bd" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 3664, hash = "58e018b2" },
