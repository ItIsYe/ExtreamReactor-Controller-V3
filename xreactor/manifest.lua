...
return {
  manifest_version = 507,
  manifest_id = "manifest-v507",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "fd108347", always = true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 9418, hash = "0bbfe12d", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/router_ui.lua", size_bytes = 36968, hash = "5f921c64", required_for={"FUEL","REPROCESSING"}},
