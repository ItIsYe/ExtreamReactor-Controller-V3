return {
  ...
  base_files = {
      ...
      { path = "release.lua", size_bytes = 330, hash = "5f834eb8", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 89555, hash = "4c4073e5", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 11843, hash = "55238037" },
    },
    energy = {
