...
return {
  manifest_version = 317,
  manifest_id = "manifest-v317",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  roles = {
    ...
    { path = "master/runtime_loop.lua", size_bytes = 12946, hash = "fc4ec810", required_for={"MASTER"} },
    ...
    { path = "master/ui/config_editor.lua", size_bytes = 3973, hash = "new", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/command_handler.lua", size_bytes = 10743, hash = "13dd99f8", required_for={"RT"} },
