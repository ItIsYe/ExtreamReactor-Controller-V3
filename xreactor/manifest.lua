...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "ad62a209", always = true },
  ...
  roles = {
    ...
    { path = "master/message_handlers.lua", size_bytes = 31337, hash = "4cb4a393", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/config.lua", size_bytes = 6758, hash = "9ed403cd", required_for={"RT"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 63148, hash = "f20d43aa", required_for={"RT"} },
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 30796, hash = "77b355af", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_adapter.lua", size_bytes = 2971, hash = "55e6bc96", required_for={"RT"} },
    { path = "nodes/rt/rt2_capacity.lua", size_bytes = 5624, hash = "11cf2aca", required_for={"RT"} },
    { path = "nodes/rt/rt2_command_handler.lua", size_bytes = 3835, hash = "8227f707", required_for={"RT"} },
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 5929, hash = "e58a3fde", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 6331, hash = "6e5b233d", required_for={"RT"} },
    { path = "nodes/rt/rt2_reactor.lua", size_bytes = 3306, hash = "bb0d0c04", required_for={"RT"} },
    { path = "nodes/rt/rt2_state.lua", size_bytes = 4918, hash = "0565d57a", required_for={"RT"} },
    { path = "nodes/rt/rt2_turbine.lua", size_bytes = 6237, hash = "ff4e3b67", required_for={"RT"} },
    ...
    { path = "adapters/logistical_sorter.lua", size_bytes = 7115, hash = "3ba939fa", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/water/ui_pages.lua", size_bytes = 11449, hash = "7278565f", required_for={"WATER"} },
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 27124, hash = "51e149fc", required_for={"FUEL"} },
    { path = "nodes/fuel/status_snapshot.lua", size_bytes = 5127, hash = "b577a61c", required_for={"FUEL"} },
    ...
    reprocessing = {
    { path = "nodes/reprocessor/color_router_ui.lua", size_bytes = 21290, hash = "28642bdf", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/config.lua", size_bytes = 3767, hash = "1e4a127f", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/config_normalizer.lua", size_bytes = 3839, hash = "3f930c15", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/feed_router.lua", size_bytes = 12515, hash = "9bf6f24b", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/main.lua", size_bytes = 23208, hash = "c78939b4", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/ui_pages.lua", size_bytes = 12302, hash = "567453ad", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 16733, hash = "f7b154c5", required_for={"VALVE"} },
