...
return {
  manifest_version = 547,
  manifest_id = "manifest-v547",
  source_ref = "beta",
  hash_algo = "crc32",

  base_files = {
  { path = "installer/http.lua", size_bytes = 2543, hash = "62cc6092", always = true  },
  { path = "installer/manifest.lua", size_bytes = 5259, hash = "3aa5f3ce", always = true  },
  ...
  { path = "installer/auto_update.lua", size_bytes = 12720, hash = "8e84537c", always = true  },
  { path = "installer/init.lua", size_bytes = 29783, hash = "97f8e461", always = true  },
  ...
  { path = "release.lua" , always = true, size_bytes = 345, hash = "8b839b36" },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 62040, hash = "1e731d0a", required_for={"RT"} },
    ...
    { path = "nodes/fuel/logistics_router.lua", size_bytes = 33375, hash = "b47cc576", required_for={"FUEL","REPROCESSING"} },
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 57954, hash = "38992985", required_for={"FUEL","REPROCESSING"} },
    ...
    { path = "nodes/valve/controller.lua", size_bytes = 11750, hash = "a8accebc", required_for={"VALVE"} },
    { path = "nodes/valve/main.lua", size_bytes = 9036, hash = "5da83e2f", required_for={"VALVE"} },
    },
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 60678, hash = "ef085ff0", required_for={"LOG"} },
