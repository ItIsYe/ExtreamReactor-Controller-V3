...
return {
  manifest_version = 350,
  manifest_id = "manifest-v350",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "1b73b1d5", always=true },
  ...
  roles = {
    ...
    { path = "master/ui/multiview.lua", size_bytes = 18725, hash = "20b7e5c4", required_for={"MASTER"} },
