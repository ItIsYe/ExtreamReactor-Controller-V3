...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "5c525f17", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 15908, hash = "471344bd", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 10003, hash = "e7c37743", required_for={"RT"} },
