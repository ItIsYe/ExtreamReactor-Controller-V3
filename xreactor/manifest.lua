...
return {
  ...
  { path = "core/logger.lua", size_bytes = 30781, hash = "d6ed5a96" },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 87373, hash = "2b1508b9", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 23025, hash = "60eb9581", required_for={"ENERGY"} },
