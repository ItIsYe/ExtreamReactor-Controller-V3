...
return {
  manifest_version = 630,
  manifest_id = "manifest-v630",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "8e61d3e6", always = true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 26890, hash = "a2308880", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 11257, hash = "667cbd61", required_for={"FUEL"} },
    { path = "nodes/fuel/monitor_scada.lua", size_bytes = 2014, hash = "47c1204c", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/logistics_router.lua", size_bytes = 41121, hash = "83e629bc", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/router_scada.lua", size_bytes = 18166, hash = "3a9c0204", required_for={"FUEL","REPROCESSING"} },
    { path = "nodes/fuel/hop_timing.lua", size_bytes = 8403, hash = "5c08903f", required_for={"FUEL"} },
    },
    reprocessing = {
    ...
    { path = "nodes/valve/config.lua", size_bytes = 2697, hash = "222d3e9b", required_for={"VALVE"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 13368, hash = "c3d17cb3", required_for={"VALVE"} },
    ...
    { path = "nodes/support/runtime.lua", size_bytes = 14216, hash = "cdccf774", required_for={"WATER","FUEL","REPROCESSING","RT","ENERGY","MASTER","VALVE"} },
