...
return {
  ...
  roles = {
    ...
    { path = "master/init_runtime.lua", size_bytes = 7498, hash = "db8dbda8", required_for={"MASTER"} },
    ...
    { path = "master/runtime_loop.lua", size_bytes = 12328, hash = "15a89ee5", required_for={"MASTER"} },
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 5585, hash = "ca52b9b4", required_for={"FUEL"} },
