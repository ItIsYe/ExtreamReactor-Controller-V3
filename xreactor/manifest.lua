...
return {
  manifest_version = 388,
  manifest_id = "manifest-v388",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "83db54f7", always=true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/router_ui.lua", size_bytes = 17714, hash = "638955c6", required_for={"FUEL","REPROCESSING"} },
    },
    reprocessing = {
