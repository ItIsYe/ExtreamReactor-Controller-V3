-- xreactor/manifest.lua -- manifest-v528
return {
  ...
  base_files = {
    ...
    { path = "installer/http.lua", size_bytes = 5392, hash = "5d257c36", always = true },
    { path = "installer/manifest.lua", size_bytes = 5794, hash = "faaa98fa", always = true },
    { path = "installer/stage.lua", size_bytes = 9253, hash = "2d7dc46d", always = true },
    ...
    { path = "installer/init.lua", size_bytes = 36140, hash = "f9015a62", always = true },
    ...
    { path = "release.lua", size_bytes = 345, hash = "ad96ffad", always = true },
    ...
    { path = "core/protocol.lua", size_bytes = 7390, hash = "89f21980" },
    ...
    { path = "core/remote_update.lua", size_bytes = 10705, hash = "63f8e684" },
    ...
    { path = "services/comms_service.lua", size_bytes = 10481, hash = "3be7cd07" },
  ...
  roles = {
    ...
    reprocessing = {
      ...
      { path = "nodes/valve/main.lua", size_bytes = 18080, hash = "e7af4343", required_for={"VALVE"} },
    },
    ...
    shared_support = {
      ...
      { path = "nodes/support/runtime.lua", size_bytes = 9620, hash = "d11b4178", required_for={"WATER", "FUEL", "REPROCESSING", "RT", "ENERGY", "MASTER", "VALVE"} },
