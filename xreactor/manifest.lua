return {
  ...
  base_files = {
      ...
      { path = "services/matrix_sampling_service.lua", size_bytes = 867, hash = "fff32232" },
  ...
  roles = {
    master = {
      ...
      { path = "master/main.lua", size_bytes = 19137, hash = "6001027b", required_for = { "MASTER" } },
      { path = "master/message_handlers.lua", size_bytes = 6773, hash = "7f003143" },
      ...
      { path = "master/ui_controller.lua", size_bytes = 15570, hash = "3d873948" },
      ...
      { path = "master/ui/rt_dashboard.lua", size_bytes = 3060, hash = "8be5e18b" },
      { path = "master/ui/widgets.lua", size_bytes = 775, hash = "aafe7d4a" },
      { path = "core/alert_rules.lua", size_bytes = 13339, hash = "480ee881" },
    ...
    energy = {
      ...
      { path = "nodes/energy/matrix_snapshot_runtime.lua", size_bytes = 17131, hash = "6243a01b" },
      { path = "nodes/energy/matrix_topology_cache.lua", size_bytes = 2052, hash = "54dc9081" },
      { path = "nodes/energy/main.lua", size_bytes = 22886, hash = "9e3467fe", required_for = { "ENERGY" } },
