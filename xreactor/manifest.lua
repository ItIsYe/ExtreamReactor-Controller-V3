return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 26572, hash = "79abd4b8" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 94515, hash = "4ca1f524", required_for = { "RT" } },
      ...
      { path = "core/turbine_ctrl.lua", size_bytes = 2172, hash = "a9b8e8b0" },
      { path = "core/turbine_regulator.lua", size_bytes = 8448, hash = "338b7bd8" },
    },
    energy = {
