...
return {
  manifest_version = 273,
  manifest_id = "manifest-v273",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "shared/constants.lua", size_bytes = 2395, hash = "0c5fb837", always=true },
  ...
  { path = "core/state_machine.lua", size_bytes = 842, hash = "4ae6c19c" },
    { path = "core/startup_report.lua", size_bytes = 3511, hash = "new", always=true },
  ...
  { path = "services/alert_service.lua", size_bytes = 12678, hash = "d04e6700" },
  ...
  roles = {
    ...
    { path = "master/init_runtime.lua", size_bytes = 7338, hash = "eba62959", required_for={"MASTER"} },
    { path = "master/main.lua", size_bytes = 244, hash = "227a851a", required_for={"MASTER"} },
    { path = "master/message_handlers.lua", size_bytes = 23923, hash = "f94edbd6", required_for={"MASTER"} },
    ...
    { path = "master/runtime_loop.lua", size_bytes = 10692, hash = "fc4ec810", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 34962, hash = "ac098c39", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 18854, hash = "78e2da3f", required_for={"ENERGY"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 22955, hash = "dd1236f0", required_for={"WATER"} },
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 21819, hash = "181bc955", required_for={"FUEL"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 23498, hash = "5613b787", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/role_descriptor.lua", size_bytes = 177, hash = "3a1d8dc9", required_for={"REPROCESSING"} },
    },
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 31180, hash = "ceb1fc06", required_for={"LOG"} },
    },
    shared_support = {
