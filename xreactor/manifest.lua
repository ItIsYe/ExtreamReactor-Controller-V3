...
return {
  ...
  { path = "release.lua", size_bytes = 273, hash = "c1f8040c", always=true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 23247, hash = "839a233e", required_for={"FUEL","REPROCESSING"} },
