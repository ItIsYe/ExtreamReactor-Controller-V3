...
return {
  ...
  roles = {
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 6360, hash = "8d75e7f9", required_for={"FUEL"} },
    ...
    reprocessing = {
    { path = "nodes/reprocessor/config.lua", size_bytes = 5233, hash = "8106e96c", required_for={"REPROCESSING"} },
