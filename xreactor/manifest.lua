...
return {
  manifest_version = 307,
  manifest_id = "manifest-v307",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 37565, hash = "ac098c39", required_for={"RT"} },
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 27375, hash = "fa733934", required_for={"RT"} },
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 14656, hash = "159857c2", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 18994, hash = "78e2da3f", required_for={"ENERGY"} },
