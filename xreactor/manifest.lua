...
return {
  manifest_version = 136,
  manifest_id = "manifest-v136",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 347, hash = "0b5f383c", always=true},
  ...
  roles = {
    ...
    { path = "nodes/rt/reactor_control.lua", size_bytes = 23762, hash = "e1e9099f", required_for={"RT"}},
