...
return {
  manifest_version = 204,
  manifest_id = "manifest-v204",
  source_ref = "beta",
  hash_algo = "none",
  ...
  { path = "release.lua", size_bytes = 273, hash = "dd390d9e", always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true},
