...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "c5b0d69f", always = true },
  ...
  roles = {
    ...
    reprocessing = {
    { path = "nodes/reprocessor/color_router_ui.lua", size_bytes = 24202, hash = "4521111d", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 30677, hash = "7cde766d", required_for={"REPROCESSING"} },
