...
return {
  manifest_version = 209,
  manifest_id = "manifest-v209",
  source_ref = "beta",
  hash_algo = "none",
  ...
  { path = "installer/auto_update.lua", size_bytes = 5695, hash = "1b4921e2", always=true},
  ...
  { path = "release.lua", size_bytes = 273, hash = "8f00ffe4", always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true},
