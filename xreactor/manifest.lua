...
return {
  ...
  { path = "release.lua", size_bytes = 273, hash = "64fbc43d", always=true },
  ...
  { path = "core/ui_router.lua", size_bytes = 8682, hash = "d59c4047" },
  ...
  roles = {
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 8346, hash = "6bd073c6", required_for={"FUEL"} },
