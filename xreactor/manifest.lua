...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "8ce71cc4", always = true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 12407, hash = "02ff0bc7", required_for={"FUEL"} },
    { path = "nodes/fuel/storage.lua", size_bytes = 2379, hash = "31ad81f2", required_for={"FUEL"} },
    { path = "nodes/fuel/ui_pages.lua", size_bytes = 22964, hash = "36768fe8", required_for={"FUEL"}},
