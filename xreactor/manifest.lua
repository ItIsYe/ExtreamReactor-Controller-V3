-- xreactor/manifest.lua -- manifest-v221
return {
  manifest_version = 221,
  manifest_id = "manifest-v221",
  source_ref = "beta",
  hash_algo = "none",
  ...
  roles = {
    ...
    { path = "master/message_handlers.lua", size_bytes = 21372, hash = "ad77b73e", required_for={"MASTER"}},
