...
return {
  ...
  { path = "release.lua", size_bytes = 273, hash = "c0649953", always=true },
  { path = "start.lua", size_bytes = 9406, hash = "21caaa68", always=true },
  ...
  roles = {
    ...
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 59720, hash = "bc979c45", required_for={"LOG"} },
