return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 15690, hash = "a6703785" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 87672, hash = "6fb47b03", required_for = { "RT" } },
      ...
      { path = "core/turbine_ctrl.lua", size_bytes = 1736, hash = "572c2cc6" },
      { path = "core/turbine_regulator.lua", size_bytes = 1878, hash = "cb2d089e" },
    },
    energy = {
