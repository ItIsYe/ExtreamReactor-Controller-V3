...
return {
  manifest_version = 325,
  manifest_id = "manifest-v325",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  roles = {
    ...
    { path = "master/ui/multiview.lua", size_bytes = 12969, hash = "1476b565", required_for={"MASTER"} },
    ...
    { path = "optional/ampel.lua", size_bytes = 3437, hash = "new", optional=true, feature="ampel", required_for={"RT","ENERGY","WATER","FUEL","REPROCESSING","LOG"} },
