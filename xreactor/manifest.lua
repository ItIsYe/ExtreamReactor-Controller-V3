...
return {
  ...
  { path = "release.lua", size_bytes = 348, hash = "43eedc5b", always=true},
  { path = "start.lua", size_bytes = 10201, hash = "b8f867c8", always=true},
  ...
  { path = "core/remote_update.lua", size_bytes = 13931, hash = "bda7d530"},
  ...
  roles = {
    ...
    { path = "nodes/energy/main.lua", size_bytes = 25528, hash = "2d24bc31", required_for={"ENERGY"}},
