...
return {
  ...
  {path="installer_manifest.lua", size_bytes=4518, hash="ed2c3bbd", always=true},
  ...
  {path="release.lua", size_bytes=344, hash="57b351bd", always=true},
  ...
  {path="core/utils.lua", size_bytes=19120, hash="aa99339a"},
  ...
  roles = {
    ...
    {path="master/message_handlers.lua", size_bytes=19344, hash="fc31f308", required_for={"MASTER"}},
    ...
    rt = {
    {path="adapters/reactor.lua", size_bytes=17010, hash="2e3b8447", required_for={"RT"}},
    ...
    {path="nodes/rt/module_lifecycle.lua", size_bytes=25907, hash="eb62cb1c", required_for={"RT"}},
    {path="nodes/rt/monitor_ui.lua", size_bytes=20550, hash="8cce26c2", required_for={"RT"}},
    ...
    energy = {
    {path="adapters/energy_storage.lua", size_bytes=3220, hash="65c983a9", required_for={"ENERGY"}},
    ...
    reprocessing = {
    {path="nodes/reprocessor/config.lua", size_bytes=3500, hash="1ace0654", required_for={"REPROCESSING"}},
    {path="nodes/reprocessor/config_normalizer.lua", size_bytes=413, hash="a4cee204", required_for={"REPROCESSING"}},
