return {
  ...
  base_files = {
      ...
      { path = "core/safety.lua", size_bytes = 3387, hash = "f5cd797a" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 13131, hash = "2e13f78e" },
      ...
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 11890, hash = "453992b3" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 90318, hash = "3df25b56", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 14094, hash = "58521a02" },
    },
    energy = {
