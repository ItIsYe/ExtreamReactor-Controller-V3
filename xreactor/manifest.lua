...
return {
  manifest_version = 384,
  manifest_id = "manifest-v384",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "8b6e17d5", always=true },
  ...
  roles = {
    ...
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 45054, hash = "3cf93ee2", required_for={"LOG"} },
