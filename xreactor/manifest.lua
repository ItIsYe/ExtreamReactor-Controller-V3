...
return {
  ...
  roles = {
    ...
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 23810, hash = "b266e5aa", required_for={"RT"}},
    ...
    { path = "nodes/rt/status_snapshot.lua", size_bytes = 10852, hash = "00772f91", required_for={"RT"}},
    },
    energy = {
