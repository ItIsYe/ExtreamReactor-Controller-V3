...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "4c47fd8e", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 63102, hash = "42f5e550", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 3766, hash = "5c7b26da", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 6112, hash = "c445df9d", required_for={"RT"} },
