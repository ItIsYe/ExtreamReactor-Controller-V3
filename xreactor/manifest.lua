return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 26316, hash = "bc135f00" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 93805, hash = "ab6791bd", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 7324, hash = "035d7ce8" },
    },
    energy = {
