-- xreactor/manifest.lua -- manifest-v543
return {
  ...
  base_files = {
    ...
    { path = "installer/http.lua", size_bytes = 3319, hash = "a9af1690", always = true },
    ...
    { path = "installer/init.lua", size_bytes = 37711, hash = "fa225c0b", always = true },
    ...
    { path = "release.lua", size_bytes = 345, hash = "32779234", always = true },
    ...
    { path = "core/mockup_ui.lua", size_bytes = 12726, hash = "c97ff03d", always = true },
    ...
    { path = "core/ui_router.lua", size_bytes = 15468, hash = "0637586e" },
    ...
    { path = "services/ui_service.lua", size_bytes = 6213, hash = "6ce5e3c8" },
  ...
  roles = {
    master = {
      ...
      { path = "master/loop.lua", size_bytes = 4420, hash = "972bf391", required_for={"MASTER"} },
      ...
      { path = "master/runtime_loop.lua", size_bytes = 18267, hash = "e492a1c3", required_for={"MASTER"} },
      ...
      { path = "master/ui/multiview.lua", size_bytes = 20855, hash = "87139387", required_for={"MASTER"} },
      ...
      { path = "master/ui_controller.lua", size_bytes = 54182, hash = "d1597c4d", required_for={"MASTER"} },
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 62033, hash = "811d6029", required_for={"RT"} },
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 27809, hash = "1b235e40", required_for={"RT"} },
      { path = "nodes/rt/monitor_ui.lua", size_bytes = 15774, hash = "4997c597", required_for={"RT"} },
    ...
    energy = {
      { path = "nodes/energy/heartbeat.lua", size_bytes = 6591, hash = "e24d494c", required_for={"ENERGY"} },
      ...
      { path = "nodes/energy/main.lua", size_bytes = 26289, hash = "0f3bede8", required_for={"ENERGY"} },
    ...
    water = {
      ...
      { path = "nodes/water/main.lua", size_bytes = 28667, hash = "d1434080", required_for={"WATER"} },
    ...
    fuel = {
      ...
      { path = "nodes/fuel/main.lua", size_bytes = 23784, hash = "c038d48a", required_for={"FUEL"} },
      ...
      { path = "nodes/fuel/monitor_ui.lua", size_bytes = 9201, hash = "7d30fced", required_for={"FUEL"} },
    ...
    reprocessing = {
      ...
      { path = "nodes/reprocessor/main.lua", size_bytes = 33382, hash = "36fe2b52", required_for={"REPROCESSING"} },
    ...
    shared_support = {
      ...
      { path = "nodes/support/runtime.lua", size_bytes = 9749, hash = "6e31f474", required_for={"WATER", "FUEL", "REPROCESSING", "RT", "ENERGY", "MASTER", "VALVE"} },
