return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 28298, hash = "547cfd92" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 96606, hash = "d307973d", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 9999, hash = "b8ba82f8" },
    },
    energy = {
