return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 21243, hash = "5975f499" },
      ...
      { path = "release.lua", size_bytes = 330, hash = "a812e461", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 91620, hash = "bfeb20c3", required_for = { "RT" } },
