...
return {
  manifest_version = 460,
  manifest_id = "manifest-v460",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "231ea808", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 59186, hash = "1eaebd30", required_for={"RT"} },
