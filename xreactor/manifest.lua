...
return {
  manifest_version = 552,
  manifest_id = "manifest-v552",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "installer/stage.lua", size_bytes = 10952, hash = "4d46c618", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "2bec85f3", always = true },
