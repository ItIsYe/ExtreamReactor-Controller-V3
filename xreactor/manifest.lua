return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 15023, hash = "57edf0a4" },
      ...
      { path = "master/ui_controller.lua", size_bytes = 17617, hash = "f47e312c" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 6285, hash = "b307236c" },
      { path = "master/ui/multiview.lua", size_bytes = 5765, hash = "7abc3e50" },
      { path = "master/ui/overview.lua", size_bytes = 9957, hash = "5c617a9b" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 5512, hash = "5dd3afc8" },
