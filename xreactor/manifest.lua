...
return {
  manifest_version = 474,
  manifest_id = "manifest-v474",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "2d22b72c", always=true, always=true, always=true},
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 24750, hash = "3e98d52a", required_for={"FUEL"}},
