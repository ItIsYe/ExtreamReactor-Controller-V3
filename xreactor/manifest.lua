...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "08d48e8f", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 11305, hash = "f4068223", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_tuning.lua", size_bytes = 8119, hash = "30d615ef", required_for={"RT"} },
