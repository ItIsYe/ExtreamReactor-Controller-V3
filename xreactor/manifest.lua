return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 22946, hash = "43be1a91" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 92163, hash = "4470dc78", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 4483, hash = "96ef785b" },
    },
    energy = {
