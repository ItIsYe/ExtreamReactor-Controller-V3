return {
  ...
  base_files = {
      ...
      { path = "release.lua", size_bytes = 351, hash = "4727d181", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 19041, hash = "0ee8a75d" },
      { path = "nodes/rt/config.lua", size_bytes = 7041, hash = "8f00cd98" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 106753, hash = "764afbbd", required_for = { "RT" } },
    ...
    energy = {
      ...
      { path = "nodes/energy/matrix_snapshot_runtime.lua", size_bytes = 15274, hash = "e5317742" },
      { path = "nodes/energy/main.lua", size_bytes = 68240, hash = "cbaf2f67", required_for = { "ENERGY" } },
