...
return {
  manifest_version = 171,
  manifest_id = "manifest-v171",
  source_ref = "beta",
  hash_algo = "none",
  ...
  { path = "release.lua", size_bytes = 348, hash = "4e209d7e", always=true},
  ...
  { path = "core/remote_update.lua", size_bytes = 12538, hash = "3cb487dd"},
  ...
  roles = {
    ...
    { path = "master/main.lua", size_bytes = 1098, hash = "cdcaaad5", required_for={"MASTER"}},
    ...
    { path = "nodes/rt/main.lua", size_bytes = 32322, hash = "78e274c8", required_for={"RT"}},
