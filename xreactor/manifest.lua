...
return {
  ...
  base_files = {
    ...
    { path = "installer/auto_update.lua", size_bytes = 10495, hash = "58b6123a", always = true },
    ...
    { path = "core/update_handshake.lua", size_bytes = 4920, hash = "8f626949", always = true },
    ...
    { path = "core/protocol.lua", size_bytes = 7125, hash = "677a46ae" },
    ...
    { path = "core/ui_router.lua", size_bytes = 10156, hash = "14652652" },
    { path = "core/utils.lua", size_bytes = 23385, hash = "59176403" },
    { path = "core/auto_update.lua", size_bytes = 5174, hash = "332b3250" },
    { path = "core/remote_update.lua", size_bytes = 11022, hash = "c9bb518f" },
    ...
    { path = "services/comms_service.lua", size_bytes = 9683, hash = "9f6f43f8" },
  ...
  roles = {
    master = {
      ...
      { path = "master/loop.lua", size_bytes = 4344, hash = "241e3896", required_for={"MASTER"} },
      ...
      { path = "master/housekeeping.lua", size_bytes = 5312, hash = "9f219ae3", required_for={"MASTER"} },
      { path = "master/fuel_relay.lua", size_bytes = 3532, hash = "88c98475", required_for={"MASTER"} },
      ...
      { path = "master/runtime_ops_profile.lua", size_bytes = 7917, hash = "dbad4755", required_for={"MASTER"} },
    ...
    rt = {
      { path = "adapters/reactor.lua", size_bytes = 14332, hash = "5821518f", required_for={"RT"} },
      ...
      { path = "nodes/rt/capacity_learning.lua", size_bytes = 4700, hash = "ffb20e53", required_for={"RT"} },
      { path = "nodes/rt/capacity_cache.lua", size_bytes = 3329, hash = "6227d9ec", required_for={"RT"} },
      ...
      { path = "nodes/rt/status_snapshot.lua", size_bytes = 6166, hash = "5c6d9f1f", required_for={"RT"} },
    },
    ...
    energy = {
      ...
      { path = "nodes/energy/matrix_snapshot_runtime.lua", size_bytes = 15942, hash = "ef70efcc", required_for={"ENERGY"} },
      ...
      { path = "nodes/energy/storage_snapshot_runtime.lua", size_bytes = 5700, hash = "2a2fe68b", required_for={"ENERGY"} },
    ...
    fuel = {
      ...
      { path = "nodes/fuel/config_normalizer.lua", size_bytes = 5738, hash = "c3238590", required_for={"FUEL"} },
      ...
      { path = "nodes/fuel/fuel_status_network.lua", size_bytes = 3881, hash = "d1aec97c", required_for={"FUEL"} },
      { path = "nodes/fuel/monitor_ui.lua", size_bytes = 8100, hash = "51502bf5", required_for={"FUEL"} },
    ...
    reprocessing = {
      ...
      { path = "nodes/valve/main.lua", size_bytes = 16468, hash = "f3bec802", required_for={"VALVE"} },
    },
    ...
    shared_support = {
      ...
      { path = "nodes/support/runtime.lua", size_bytes = 9734, hash = "933238cb", required_for={"WATER", "FUEL", "REPROCESSING", "RT", "ENERGY", "MASTER", "VALVE"} },
