...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "24958918", always = true },
  ...
  roles = {
    ...
    { path = "nodes/reprocessor/feed_router.lua", size_bytes = 17782, hash = "00c92fa4", required_for={"REPROCESSING"} },
