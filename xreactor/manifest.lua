...
return {
  manifest_version = 172,
  manifest_id = "manifest-v172",
  source_ref = "beta",
  hash_algo = "none",
  ...
  { path = "release.lua", size_bytes = 348, hash = "23b73377", always=true},
  ...
  { path = "core/remote_update.lua", size_bytes = 13477, hash = "3b883a6e"},
