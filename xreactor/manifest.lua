...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "90673f60", always = true },
  ...
  roles = {
    ...
    { path = "nodes/reprocessor/config_normalizer.lua", size_bytes = 3612, hash = "eb2d8faf", required_for={"REPROCESSING"} },
