return {
  ...
  base_files = {
      ...
      { path = "core/safety.lua", size_bytes = 5636, hash = "2ca386ba" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 14036, hash = "6a952ca4" },
      ...
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 15767, hash = "48fb9701" },
      ...
      { path = "nodes/rt/status_snapshot.lua", size_bytes = 3507, hash = "52a474fd" },
      { path = "nodes/rt/main.lua", size_bytes = 91767, hash = "472cc1ee", required_for = { "RT" } },
      { path = "nodes/rt/state_handlers.lua", size_bytes = 4329, hash = "34ef2d43" },
      { path = "adapters/reactor.lua", size_bytes = 15811, hash = "47c5cced" },
      { path = "adapters/turbine.lua", size_bytes = 3871, hash = "a9e924f3" },
      { path = "core/control_rails.lua", size_bytes = 4278, hash = "149674ad" },
      { path = "core/fluid.lua", size_bytes = 1898, hash = "36df0edf" },
