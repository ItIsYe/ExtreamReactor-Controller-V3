-- xreactor/manifest.lua -- manifest-v41
return {
  manifest_version = 41,
  ...
  { path = "release.lua", size_bytes = 345, hash = "39d0d984", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 92638, hash = "0b67d93a", required_for={"RT"} },
