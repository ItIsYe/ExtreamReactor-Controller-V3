return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 8749, hash = "25685df3", required_for = { "MASTER" } },
      ...
      { path = "master/init_runtime.lua", size_bytes = 6036, hash = "960c7aa1", required_for = { "MASTER" } },
