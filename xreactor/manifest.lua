...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "895c862f", always = true },
  ...
  roles = {
    ...
    reprocessing = {
    { path = "nodes/reprocessor/color_router_ui.lua", size_bytes = 18732, hash = "89123aa4", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 26094, hash = "e4e023ed", required_for={"REPROCESSING"} },
