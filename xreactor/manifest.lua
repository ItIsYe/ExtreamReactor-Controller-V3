return {
  ...
  base_files = {
      ...
      { path = "release.lua", size_bytes = 340, hash = "c75fa257", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 16584, hash = "af8cce5d" },
      { path = "nodes/rt/config.lua", size_bytes = 6602, hash = "5886862d" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 103147, hash = "ae57a8e4", required_for = { "RT" } },
