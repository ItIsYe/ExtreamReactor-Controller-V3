return {
  ...
  base_files = {
      ...
      { path = "release.lua", size_bytes = 342, hash = "ec331927", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 12521, hash = "f86f47d1" },
      { path = "nodes/rt/config.lua", size_bytes = 6037, hash = "827e7bf8" },
      ...
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 10740, hash = "44295590" },
      { path = "nodes/rt/flow_apply_helpers.lua", size_bytes = 7938, hash = "a54aeb85" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 89740, hash = "38900f4d", required_for = { "RT" } },
      ...
      { path = "core/turbine_ctrl.lua", size_bytes = 2749, hash = "8eb1e874" },
      { path = "core/turbine_regulator.lua", size_bytes = 13817, hash = "57dcb2d5" },
    },
    energy = {
