...
return {
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 19865, hash = "fb399628", required_for={"FUEL"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 19844, hash = "888b8fc2", required_for={"REPROCESSING"} },
