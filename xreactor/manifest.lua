...
return {
  ...
  roles = {
    ...
    { path = "nodes/rt/reactor_control.lua", size_bytes = 35989, hash = "62e7f429", required_for={"RT"} },
    ...
    { path = "nodes/rt/config.lua", size_bytes = 5255, hash = "0aac8b10", required_for={"RT"} },
    { path = "nodes/rt/config_normalizer.lua", size_bytes = 27143, hash = "1605bd26", required_for={"RT"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 47766, hash = "64e8d0e1", required_for={"RT"} },
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 29130, hash = "4cbf6194", required_for={"RT"} },
    ...
    { path = "nodes/rt/state_handlers.lua", size_bytes = 9970, hash = "51746640", required_for={"RT"} },
