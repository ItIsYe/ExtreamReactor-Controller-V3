return {
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config.lua", size_bytes = 6295, hash = "1dd34b93" },
      ...
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 20608, hash = "ae1fb87d" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 97541, hash = "189b77d3", required_for = { "RT" } },
