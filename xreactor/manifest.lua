...
return {
  manifest_version = 414,
  manifest_id = "manifest-v414",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "70bbc72d", always=true },
  ...
  roles = {
    ...
    { path = "nodes/water/main.lua", size_bytes = 24481, hash = "c25c02ac", required_for={"WATER"} },
