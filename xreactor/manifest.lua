...
return {
  ...
  roles = {
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 4738, hash = "70e03f38", required_for={"FUEL"} },
    ...
    reprocessing = {
    { path = "nodes/reprocessor/config.lua", size_bytes = 3714, hash = "e742eb7c", required_for={"REPROCESSING"} },
