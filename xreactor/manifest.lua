...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "f0ca6847", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/rt2_capacity.lua", size_bytes = 7684, hash = "ad73bfb4", required_for={"RT"} },
    { path = "nodes/rt/rt2_command_handler.lua", size_bytes = 5199, hash = "d8141714", required_for={"RT"} },
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 12349, hash = "998a9139", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 9962, hash = "244657d0", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_turbine.lua", size_bytes = 12457, hash = "2bf105eb", required_for={"RT"} },
