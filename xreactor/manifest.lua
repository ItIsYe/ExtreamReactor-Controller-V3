...
return {
  manifest_version = 708,
  manifest_id = "manifest-v708",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "03e5d363", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 63654, hash = "b994ed45", required_for={"RT"} },
