...
return {
  manifest_version = 714,
  manifest_id = "manifest-v714",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "5b41c10b", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 64220, hash = "0cb737c0", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 6847, hash = "3476e4e4", required_for={"RT"} },
