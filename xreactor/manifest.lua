...
return {
  ...
  { path = "installer/auto_update.lua", size_bytes = 5260, hash = "486532b6", always=true},
  ...
  { path = "release.lua", size_bytes = 273, hash = "32acde76", always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true},
