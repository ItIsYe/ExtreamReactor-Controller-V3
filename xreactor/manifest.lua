...
return {
  ...
  { path = "installer/manifest.lua", size_bytes = 8613, hash = "9a8a0576", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "7ba51b70", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 68059, hash = "0bb32ed1", required_for={"RT"} },
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 30796, hash = "77b355af", required_for={"RT"} },
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 15254, hash = "bee2263d", required_for={"RT"} },
    { path = "nodes/rt/mockup_pages.lua", size_bytes = 17965, hash = "e8a27c9c", required_for={"RT"} },
    { path = "nodes/rt/reactor_steam_guard.lua", size_bytes = 2613, hash = "2f2fa78c", required_for={"RT"} },
    { path = "nodes/rt/rt2_adapter.lua", size_bytes = 4802, hash = "1cf7e451", required_for={"RT"} },
    { path = "nodes/rt/rt2_capacity.lua", size_bytes = 13066, hash = "b98f7dbc", required_for={"RT"} },
    { path = "nodes/rt/rt2_command_handler.lua", size_bytes = 5199, hash = "d8141714", required_for={"RT"} },
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 21222, hash = "5d295f05", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 12744, hash = "c05de8fe", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_turbine_model.lua", size_bytes = 10445, hash = "01747897", required_for={"RT"} },
