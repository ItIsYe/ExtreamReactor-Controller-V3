...
return {
  manifest_version = 546,
  manifest_id = "manifest-v546",
  source_ref = "beta",
  hash_algo = "crc32",

  base_files = {
  { path = "installer/http.lua", size_bytes = 3948, hash = "96b3ae8a", always = true  },
  { path = "installer/manifest.lua", size_bytes = 5765, hash = "a3fbbb14", always = true  },
  ...
  { path = "installer/init.lua", size_bytes = 29629, hash = "82ff70d8", always = true  },
  ...
  { path = "release.lua" , always = true, size_bytes = 345, hash = "942caea5" },
  ...
  { path = "core/mockup_ui.lua", size_bytes = 11743, hash = "69d15760", always = true  },
  ...
  { path = "core/ui_router.lua", size_bytes = 21477, hash = "e3e73014" },
  { path = "core/window_buffer.lua", size_bytes = 3681, hash = "1743677d", required_for={"FUEL"} },
  ...
  { path = "services/comms_service.lua", size_bytes = 10144, hash = "7446f0a6"  },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 61157, hash = "e4840133", required_for={"RT"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 28401, hash = "167c9018", required_for={"WATER"} },
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 23265, hash = "f6376744", required_for={"FUEL"}},
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 8365, hash = "3f8e034f", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/logistics_router.lua", size_bytes = 29155, hash = "be06eb14", required_for={"FUEL","REPROCESSING"} },
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 50818, hash = "63190671", required_for={"FUEL","REPROCESSING"} },
    ...
    { path = "nodes/reprocessor/feed_router.lua", size_bytes = 10342, hash = "eb645640", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/main.lua", size_bytes = 33004, hash = "8224d7d5", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 31756, hash = "aac9f47d", required_for={"VALVE"} },
    },
    log = {
    ...
    { path = "nodes/support/discovery.lua", size_bytes = 2778, hash = "e38f2dac", required_for={"WATER", "FUEL", "REPROCESSING"} },
    { path = "nodes/support/role_logic.lua", size_bytes = 571, hash = "a3d15a39", required_for={"ENERGY", "WATER", "FUEL", "REPROCESSING", "RT"} },
    { path = "nodes/support/runtime.lua", size_bytes = 9320, hash = "36079ce0", required_for={"WATER", "FUEL", "REPROCESSING", "RT", "ENERGY", "MASTER", "VALVE"} },
