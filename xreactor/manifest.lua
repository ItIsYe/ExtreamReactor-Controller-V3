-- xreactor/manifest.lua -- manifest-v40
return {
  manifest_version = 40,
  ...
  { path = "release.lua", size_bytes = 345, hash = "e9106312", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 93020, hash = "814c9965", required_for={"RT"} },
