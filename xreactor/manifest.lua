...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "d63ee03e", always = true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/monitor_scada.lua", size_bytes = 4747, hash = "7c0db8be", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/scada_layout.lua", size_bytes = 22742, hash = "9238d1a8", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/router_scada.lua", size_bytes = 18674, hash = "9644474a", required_for={"FUEL","REPROCESSING"} },
