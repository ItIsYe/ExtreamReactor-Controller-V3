...
return {
  manifest_version = 203,
  manifest_id = "manifest-v203",
  source_ref = "beta",
  hash_algo = "none",
  ...
  { path = "release.lua", size_bytes = 273, hash = "83ef1d57", always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true},
