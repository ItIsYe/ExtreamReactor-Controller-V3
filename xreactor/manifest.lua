return {
  ...
  roles = {
    master = {
      ...
      { path = "master/ui/energy.lua", size_bytes = 7370, hash = "0f837a23" },
      { path = "master/ui/multiview.lua", size_bytes = 3861, hash = "c98ffb38" },
      { path = "master/ui/overview.lua", size_bytes = 11226, hash = "ba4f7ff6" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 7661, hash = "b9e4e7b6" },
