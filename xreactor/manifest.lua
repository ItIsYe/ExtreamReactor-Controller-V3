...
return {
  manifest_version = 406,
  manifest_id = "manifest-v406",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "a048f0ea", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 41396, hash = "2a8170e3", required_for={"RT"} },
