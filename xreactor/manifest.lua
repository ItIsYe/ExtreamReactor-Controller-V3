return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 9907, hash = "b647269a", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 6621, hash = "44fccf3a" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 2898, hash = "63c51541" },
      { path = "master/ui/multiview.lua", size_bytes = 4430, hash = "b3b831d3" },
      { path = "master/ui/overview.lua", size_bytes = 6040, hash = "f4688041" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 3265, hash = "aab7e86b" },
      { path = "master/ui/widgets.lua", size_bytes = 4181, hash = "ea832b9b" },
