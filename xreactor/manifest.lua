return {
  ...
  roles = {
    master = {
      ...
      { path = "master/ui/energy.lua", size_bytes = 2522, hash = "68df9851" },
      { path = "master/ui/multiview.lua", size_bytes = 3060, hash = "25703741" },
      { path = "master/ui/overview.lua", size_bytes = 4956, hash = "bc47f8b0" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 2547, hash = "fbe8bedd" },
      { path = "master/ui/widgets.lua", size_bytes = 2450, hash = "ff786bc7" },
