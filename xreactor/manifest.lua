...
return {
  manifest_version = 472,
  manifest_id = "manifest-v472",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 24674, hash = "5b50b8b6", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 50240, hash = "7be14d5d", required_for={"FUEL","REPROCESSING","WATER"} },
    { path = "nodes/fuel/router_ui.lua", size_bytes = 34520, hash = "27144b13", required_for={"FUEL","REPROCESSING"} },
    },
    reprocessing = {
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 32976, hash = "92d57552", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 28951, hash = "28e95eed", required_for={"VALVE"} },
    },
    log = {
