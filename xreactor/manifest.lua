return {
  ...
  base_files = {
      ...
      { path = "installer_main.lua", size_bytes = 16012, hash = "661be3a0", always = true },
      ...
      { path = "release.lua", size_bytes = 385, hash = "eaa87b68", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 79191, hash = "7d1d5907", required_for = { "RT" } },
