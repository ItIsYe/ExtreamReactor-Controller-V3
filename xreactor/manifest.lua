...
return {
  ...
  { path = "installer_main.lua", size_bytes = 24498, hash = "d5c6f119", always=true},
  ...
  { path = "core/remote_update.lua", size_bytes = 2564, hash = "36644a2c"},
  ...
  roles = {
    ...
    { path = "nodes/rt/command_handler.lua", size_bytes = 11518, hash = "7995cbcc", required_for={"RT"}},
