...
return {
  manifest_version = 478,
  manifest_id = "manifest-v478",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "08431750", always=true, always=true, always=true, always=true, always=true, always=true, always=true},
