...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "f7c7a401", always = true },
  ...
  roles = {
    ...
    { path = "nodes/reprocessor/feed_router.lua", size_bytes = 16710, hash = "d6fe2133", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/main.lua", size_bytes = 30617, hash = "9e95c21f", required_for={"REPROCESSING"} },
