...
return {
  ...
  base_files = {
    ...
    { path = "core/comms.lua", size_bytes = 32897, hash = "089ac71e" },
    ...
    { path = "core/protocol.lua", size_bytes = 16367, hash = "bf0e726e" },
    ...
    { path = "services/comms_service.lua", size_bytes = 10756, hash = "816b74a7" },
  ...
  roles = {
    ...
    reprocessing = {
      ...
      { path = "nodes/valve/main.lua", size_bytes = 20811, hash = "21d070df", required_for={"VALVE"} },
    },
