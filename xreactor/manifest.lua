-- xreactor/manifest.lua -- manifest-v30
return {
  manifest_version = 30,
  manifest_id = "manifest-v30",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "d1a32ffd", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 92357, hash = "4ecbda41", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 23355, hash = "d32bbbaf", required_for={"ENERGY"} },
    ...
    { path = "nodes/energy/ui_pages.lua", size_bytes = 8317, hash = "0843d427", required_for={"ENERGY"} },
    },
    water = {
