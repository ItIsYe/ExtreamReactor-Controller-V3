...
return {
  manifest_version = 581,
  manifest_id = "manifest-v581",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "installer/auto_update.lua", size_bytes = 14618, hash = "338d2e09", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "98410bb4", always = true },
  ...
  { path = "core/ui_router.lua", size_bytes = 16842, hash = "50cd5b0c" },
  ...
  roles = {
    ...
    { path = "nodes/rt/turbine_control.lua", size_bytes = 41356, hash = "f35bfb85", required_for={"RT"} },
    ...
    { path = "nodes/rt/config_normalizer.lua", size_bytes = 26167, hash = "ee8a5515", required_for={"RT"} },
