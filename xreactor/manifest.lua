...
return {
  ...
  { path = "installer/stage.lua", size_bytes = 8884, hash = "83555051", always = true },
  { path = "installer/ui.lua", size_bytes = 1971, hash = "02e204ae", always = true },
  { path = "installer/auto_update.lua", size_bytes = 19624, hash = "9f4590ce", always = true },
  { path = "installer/init.lua", size_bytes = 18637, hash = "cf0e15a4", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "a0591415", always = true },
  ...
  { path = "core/registry.lua", size_bytes = 12798, hash = "25c1dc1e", required_for={"MASTER","RT","ENERGY","WATER","FUEL","REPROCESSING"} },
  ...
  roles = {
    ...
    { path = "core/alert_rules.lua", size_bytes = 19847, hash = "a1322c5a", required_for={"MASTER"} },
    ...
    { path = "master/init_runtime.lua", size_bytes = 8295, hash = "0401003b", required_for={"MASTER"} },
    { path = "master/main.lua", size_bytes = 244, hash = "227a851a", required_for={"MASTER"} },
    { path = "master/message_handlers.lua", size_bytes = 29825, hash = "713f2d82", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 50635, hash = "c8c59a49", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 21966, hash = "b6f7ecd6", required_for={"ENERGY"} },
    ...
    { path = "nodes/energy/ui_pages.lua", size_bytes = 19332, hash = "e7bfd612", required_for={"ENERGY"} },
    },
    water = {
    ...
    { path = "nodes/water/main.lua", size_bytes = 26491, hash = "6560e8f9", required_for={"WATER"} },
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 8807, hash = "9c8770f5", required_for={"FUEL"} },
    { path = "nodes/fuel/config_normalizer.lua", size_bytes = 7872, hash = "8aabe8a7", required_for={"FUEL"} },
    { path = "nodes/fuel/main.lua", size_bytes = 27065, hash = "edc77a26", required_for={"FUEL"} },
    { path = "nodes/fuel/status_snapshot.lua", size_bytes = 4662, hash = "cc71fd01", required_for={"FUEL"} },
    { path = "nodes/fuel/operational_summary.lua", size_bytes = 8557, hash = "4cd946d9", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 12395, hash = "278cc231", required_for={"FUEL"} },
    { path = "nodes/fuel/monitor_scada.lua", size_bytes = 7045, hash = "2b7c5cd2", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 46545, hash = "897ddbac", required_for={"FUEL","REPROCESSING"} },
    { path = "nodes/fuel/router_ui.lua", size_bytes = 24654, hash = "6a2a4b93", required_for={"FUEL","REPROCESSING"} },
    { path = "nodes/fuel/router_scada.lua", size_bytes = 18166, hash = "7d788b45", required_for={"FUEL","REPROCESSING"} },
    ...
    { path = "nodes/reprocessor/feed_router.lua", size_bytes = 9667, hash = "76c65316", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/main.lua", size_bytes = 28991, hash = "7f454235", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/config.lua", size_bytes = 2788, hash = "a449c981", required_for={"VALVE"} },
    { path = "nodes/valve/controller.lua", size_bytes = 15625, hash = "97893f5a", required_for={"VALVE"} },
    { path = "nodes/valve/hop_reporter.lua", size_bytes = 2144, hash = "3099e0bf", required_for={"VALVE"} },
    { path = "nodes/valve/local_ui.lua", size_bytes = 19280, hash = "7870b4f7", required_for={"VALVE"} },
    { path = "nodes/valve/main.lua", size_bytes = 15756, hash = "c46d6d68", required_for={"VALVE"} },
    ...
    { path = "nodes/support/runtime.lua", size_bytes = 14319, hash = "e1fdf15f", required_for={"WATER","FUEL","REPROCESSING","RT","ENERGY","MASTER","VALVE"} },
