...
return {
  ...
  roles = {
    ...
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 21646, hash = "b3bc3ca4", required_for={"RT"}},
    ...
    { path = "nodes/rt/status_snapshot.lua", size_bytes = 10319, hash = "04f33838", required_for={"RT"}},
    },
    energy = {
