return {
  ...
  hash_algo = "crc32",
  base_files = {
      { path = "adapters/monitor.lua", size_bytes = 4334, hash = "0850af70" },
      ...
      { path = "core/network.lua", size_bytes = 13582, hash = "d69a3c0a" },
      ...
      { path = "core/ui.lua", size_bytes = 10684, hash = "19b1dd35" },
      { path = "core/ui_router.lua", size_bytes = 6305, hash = "e626dd67" },
      { path = "core/utils.lua", size_bytes = 8466, hash = "a0e346aa" },
      { path = "release.lua", size_bytes = 330, hash = "93cdaf32", always = true },
  ...
  roles = {
    master = {
      ...
      { path = "core/monitor_manager.lua", size_bytes = 3380, hash = "58719d5f" },
    ...
    rt = {
      ...
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 10450, hash = "550f45c5" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 81846, hash = "53d3775f", required_for = { "RT" } },
      { path = "nodes/rt/state_handlers.lua", size_bytes = 4062, hash = "4afb2a66" },
      { path = "adapters/reactor.lua", size_bytes = 13067, hash = "204e1497" },
    ...
    water = {
      ...
      { path = "nodes/water/main.lua", size_bytes = 25164, hash = "186b8bc2", required_for = { "WATER" } },
    },
    fuel = {
      { path = "nodes/fuel/config.lua", size_bytes = 3704, hash = "ae225506" },
      { path = "nodes/fuel/main.lua", size_bytes = 24881, hash = "de39419e", required_for = { "FUEL" } },
    },
    reprocessing = {
      { path = "nodes/reprocessor/config.lua", size_bytes = 3500, hash = "1ace0654" },
      { path = "nodes/reprocessor/main.lua", size_bytes = 24713, hash = "ecd51c8a", required_for = { "REPROCESSING" } },
    },
  }
}
