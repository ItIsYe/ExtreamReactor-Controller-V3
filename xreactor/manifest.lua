return {
  ...
  roles = {
    master = {
      ...
      { path = "master/ui_controller.lua", size_bytes = 9125, hash = "168ffa19" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 3998, hash = "1a46b050" },
      { path = "master/ui/multiview.lua", size_bytes = 4390, hash = "a9924116" },
      { path = "master/ui/overview.lua", size_bytes = 7494, hash = "e3028263" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 4125, hash = "7493631f" },
      { path = "master/ui/widgets.lua", size_bytes = 5856, hash = "286e6086" },
