...
return {
  ...
  roles = {
    ...
    { path = "master/message_handlers.lua", size_bytes = 19520, hash = "0b5f9fa5", required_for={"MASTER"}},
    ...
    { path = "master/rt_sync.lua", size_bytes = 20391, hash = "9c2cab40", required_for={"MASTER"}},
    { path = "master/rt_sync_coalescer.lua", size_bytes = 7380, hash = "a80c06c2", required_for={"MASTER"}},
    ...
    { path = "nodes/rt/command_handler.lua", size_bytes = 10599, hash = "e8183b3f", required_for={"RT"}},
    ...
    { path = "nodes/rt/main.lua", size_bytes = 99128, hash = "d1a2c4bc", required_for={"RT"}},
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 27375, hash = "fa733934", required_for={"RT"}},
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 23907, hash = "1530dc65", required_for={"RT"}},
    ...
    { path = "nodes/rt/status_snapshot.lua", size_bytes = 10668, hash = "ff8be868", required_for={"RT"}},
    },
    energy = {
