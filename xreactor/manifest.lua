return {
  ...
  roles = {
    master = {
      ...
      { path = "master/main.lua", size_bytes = 26869, hash = "91e293a8", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 17038, hash = "6b086945" },
      ...
      { path = "master/ui/rt_dashboard.lua", size_bytes = 3975, hash = "222b2c07" },
    ...
    rt = {
      ...
      { path = "nodes/rt/command_handler.lua", size_bytes = 4809, hash = "c6f850bb" },
    ...
    energy = {
      ...
      { path = "nodes/energy/status_payload.lua", size_bytes = 7788, hash = "11d21f26" },
