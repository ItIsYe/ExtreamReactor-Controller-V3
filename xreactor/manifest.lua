...
return {
  manifest_version = 276,
  manifest_id = "manifest-v276",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  roles = {
    ...
    { path = "master/init_runtime.lua", size_bytes = 7492, hash = "eba62959", required_for={"MASTER"} },
    ...
    { path = "master/runtime_loop.lua", size_bytes = 11179, hash = "fc4ec810", required_for={"MASTER"} },
    ...
    { path = "master/ui_controller.lua", size_bytes = 40018, hash = "89b29492", required_for={"MASTER"} },
