...
return {
  manifest_version = 401,
  manifest_id = "manifest-v401",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "fe9ee023", always=true },
  ...
  roles = {
    ...
    { path = "master/runtime_loop.lua", size_bytes = 15647, hash = "27f4aeb5", required_for={"MASTER"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 20726, hash = "1a01f5b9", required_for={"ENERGY"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 19948, hash = "25d706a7", required_for={"WATER"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 19537, hash = "7d29873f", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 11440, hash = "9a2d8705", required_for={"VALVE"} },
    },
    log = {
    ...
    { path = "nodes/support/runtime.lua", size_bytes = 6963, hash = "f792f39a", required_for={"WATER", "FUEL", "REPROCESSING", "RT"} },
