...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "09d74291", always = true },
  ...
  roles = {
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 8814, hash = "4f908586", required_for={"FUEL"} },
    { path = "nodes/fuel/config_normalizer.lua", size_bytes = 7872, hash = "8aabe8a7", required_for={"FUEL"} },
    { path = "nodes/fuel/main.lua", size_bytes = 27139, hash = "ff6b2142", required_for={"FUEL"} },
    ...
    { path = "nodes/valve/local_ui.lua", size_bytes = 18939, hash = "4e926f9d", required_for={"VALVE"} },
