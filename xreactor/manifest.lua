...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "52289fe2", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/reactor_control.lua", size_bytes = 35235, hash = "3f74f505", required_for={"RT"} },
    ...
    { path = "nodes/rt/config.lua", size_bytes = 4785, hash = "3cc37b3e", required_for={"RT"} },
    ...
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 27638, hash = "926edb2c", required_for={"RT"} },
    ...
    { path = "nodes/fuel/ui_pages.lua", size_bytes = 23780, hash = "ffd320ec", required_for={"FUEL"} },
    ...
    shared_support = {
    { path = "nodes/support/command_handler.lua", size_bytes = 4334, hash = "ec85b322", required_for={"WATER", "FUEL", "REPROCESSING"} },
