return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 26832, hash = "3ea68f8e" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 96306, hash = "8039b0d6", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 9498, hash = "a0de528f" },
    },
    energy = {
