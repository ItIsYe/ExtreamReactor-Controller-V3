return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 18185, hash = "998a0bb3" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 90212, hash = "ba52288f", required_for = { "RT" } },
      ...
      { path = "core/turbine_ctrl.lua", size_bytes = 1995, hash = "341f5286" },
      { path = "core/turbine_regulator.lua", size_bytes = 3681, hash = "e6950a37" },
    },
    energy = {
