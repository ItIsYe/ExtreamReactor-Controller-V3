return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 17543, hash = "9d6bd84c" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 89235, hash = "19c4bfe0", required_for = { "RT" } },
      ...
      { path = "core/turbine_ctrl.lua", size_bytes = 1914, hash = "d4d4213c" },
      { path = "core/turbine_regulator.lua", size_bytes = 3286, hash = "42c75282" },
    },
    energy = {
