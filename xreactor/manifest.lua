...
return {
  ...
  { path = "release.lua", size_bytes = 348, hash = "4356cc37", always=true},
  { path = "start.lua", size_bytes = 10006, hash = "08d779a3", always=true},
  ...
  { path = "core/remote_update.lua", size_bytes = 13567, hash = "716550ce"},
