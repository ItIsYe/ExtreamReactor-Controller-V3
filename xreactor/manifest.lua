return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 6865, hash = "67251291" },
      ...
      { path = "release.lua", size_bytes = 330, hash = "21e416ee", always = true },
      ...
      { path = "start.lua", size_bytes = 2031, hash = "ee07f57c", always = true },
