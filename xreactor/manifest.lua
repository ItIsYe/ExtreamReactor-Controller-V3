...
return {
  ...
  roles = {
    ...
    { path = "master/init_runtime.lua", size_bytes = 7700, hash = "eba62959", required_for={"MASTER"} },
    { path = "master/main.lua", size_bytes = 244, hash = "227a851a", required_for={"MASTER"} },
    { path = "master/message_handlers.lua", size_bytes = 24436, hash = "f94edbd6", required_for={"MASTER"} },
    ...
    { path = "master/runtime_loop.lua", size_bytes = 11356, hash = "fc4ec810", required_for={"MASTER"} },
    ...
    { path = "master/ui_controller.lua", size_bytes = 42377, hash = "89b29492", required_for={"MASTER"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 23099, hash = "dd1236f0", required_for={"WATER"} },
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 21963, hash = "181bc955", required_for={"FUEL"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 23642, hash = "5613b787", required_for={"REPROCESSING"} },
