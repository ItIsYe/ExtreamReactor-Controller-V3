...
return {
  manifest_version = 549,
  manifest_id = "manifest-v549",
  source_ref = "beta",
  hash_algo = "crc32",

  base_files = {
  { path = "installer/http.lua", size_bytes = 2543, hash = "62cc6092", always = true },
  { path = "installer/manifest.lua", size_bytes = 6193, hash = "d18dcc0b", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "c421b5db", always = true },
