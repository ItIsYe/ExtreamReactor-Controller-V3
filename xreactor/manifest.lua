return {
  ...
  base_files = {
      ...
      { path = "installer_main.lua", size_bytes = 16012, hash = "bb0292d2", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 78880, hash = "4dec86d0", required_for = { "RT" } },
    ...
    energy = {
      ...
      { path = "nodes/energy/matrix_snapshot_runtime.lua", size_bytes = 17396, hash = "19b7bd8d" },
