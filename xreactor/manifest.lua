...
return {
  manifest_version = 355,
  manifest_id = "manifest-v355",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "f0bcc3ac", always=true },
  ...
  roles = {
    ...
    { path = "master/ui/alerts.lua", size_bytes = 26718, hash = "7adf7f79", required_for={"MASTER"} },
