...
return {
  ...
  roles = {
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 6941, hash = "6bacccb4", required_for={"FUEL"} },
    ...
    reprocessing = {
    { path = "nodes/reprocessor/config.lua", size_bytes = 5829, hash = "f2ba6d9e", required_for={"REPROCESSING"} },
