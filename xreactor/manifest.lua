return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 13576, hash = "ecb76424", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 14151, hash = "a5591b48" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 5111, hash = "a3c7da29" },
      ...
      { path = "master/ui/rt_dashboard.lua", size_bytes = 4728, hash = "7fcffbb6" },
