return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 14258, hash = "4b499df0", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 16899, hash = "7dfcef9a" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 6109, hash = "68dca7bc" },
      { path = "master/ui/multiview.lua", size_bytes = 4738, hash = "23f1c22c" },
      { path = "master/ui/overview.lua", size_bytes = 9704, hash = "c242c63b" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 5224, hash = "abc83a18" },
