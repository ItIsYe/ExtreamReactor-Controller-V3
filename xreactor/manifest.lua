return {
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 15996, hash = "92f3d7f0" },
      { path = "nodes/rt/config.lua", size_bytes = 6453, hash = "5d55bdb1" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 96417, hash = "c6c2dce0", required_for = { "RT" } },
