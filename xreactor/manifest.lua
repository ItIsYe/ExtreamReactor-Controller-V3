-- xreactor/manifest.lua -- manifest-v542
return {
  ...
  base_files = {
    ...
    { path = "release.lua", size_bytes = 345, hash = "d352cdb3", always = true },
    ...
    { path = "core/ui_router.lua", size_bytes = 14283, hash = "202e7d79" },
    ...
    { path = "services/ui_service.lua", size_bytes = 5763, hash = "1c12b801" },
  ...
  roles = {
    ...
    fuel = {
      ...
      { path = "nodes/fuel/monitor_ui.lua", size_bytes = 9143, hash = "50b3433e", required_for={"FUEL"} },
