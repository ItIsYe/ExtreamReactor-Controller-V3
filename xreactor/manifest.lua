...
return {
  manifest_version = 693,
  manifest_id = "manifest-v693",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "installer/auto_update.lua", size_bytes = 21098, hash = "7aedd853", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "9dc12e92", always = true },
  ...
  { path = "core/update_handshake.lua", size_bytes = 5705, hash = "879a1cbb", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/turbine_control.lua", size_bytes = 43140, hash = "8c45f510", required_for={"RT"} },
    ...
    { path = "nodes/rt/state_handlers.lua", size_bytes = 13538, hash = "6adf1011", required_for={"RT"} },
