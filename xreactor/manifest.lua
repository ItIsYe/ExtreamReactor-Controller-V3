...
return {
  manifest_version = 385,
  manifest_id = "manifest-v385",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "d1e2a68d", always=true },
  ...
  { path = "core/ui_router.lua", size_bytes = 8439, hash = "d8f22dc9" },
  ...
  { path = "services/ui_service.lua", size_bytes = 2710, hash = "e7778ac8" },
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 15088, hash = "4957f67b", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 6549, hash = "9083c856", required_for={"FUEL"} },
