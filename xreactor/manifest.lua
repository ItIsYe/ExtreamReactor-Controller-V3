return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_ops_monitor.lua", size_bytes = 2138, hash = "5c5509b6", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 21738, hash = "8e33b37c" },
      { path = "master/monitor_sessions.lua", size_bytes = 5355, hash = "bb8a9411" },
      ...
      { path = "master/ui/energy.lua", size_bytes = 7130, hash = "05673d60" },
      { path = "master/ui/multiview.lua", size_bytes = 3810, hash = "fa0ff1a4" },
      { path = "master/ui/overview.lua", size_bytes = 10825, hash = "4c75d471" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 7495, hash = "6ba30c04" },
      ...
      { path = "core/monitor_manager.lua", size_bytes = 5071, hash = "a3f12603" },
