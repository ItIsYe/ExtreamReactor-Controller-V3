return {
  ...
  base_files = {
      ...
      { path = "services/matrix_sampling_service.lua", size_bytes = 862, hash = "7d48a18c" },
  ...
  roles = {
    master = {
      ...
      { path = "master/message_handlers.lua", size_bytes = 6339, hash = "dea1972a" },
    ...
    energy = {
      ...
      { path = "nodes/energy/matrix_snapshot_runtime.lua", size_bytes = 16820, hash = "65fd91d8" },
      { path = "nodes/energy/matrix_topology_cache.lua", size_bytes = 2052, hash = "54dc9081" },
      { path = "nodes/energy/main.lua", size_bytes = 22887, hash = "50825daf", required_for = { "ENERGY" } },
