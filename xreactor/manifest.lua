-- xreactor/manifest.lua -- manifest-v42
return {
  manifest_version = 42,
  ...
  { path = "release.lua", size_bytes = 345, hash = "93e0107f", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 94997, hash = "6db1fcfa", required_for={"RT"} },
