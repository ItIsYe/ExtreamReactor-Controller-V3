...
return {
  manifest_version = 386,
  manifest_id = "manifest-v386",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "3e777565", always=true },
  ...
  { path = "core/ui_router.lua", size_bytes = 8464, hash = "7f0a295d" },
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 15644, hash = "dcd0a4a7", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 7590, hash = "014192b5", required_for={"FUEL"} },
