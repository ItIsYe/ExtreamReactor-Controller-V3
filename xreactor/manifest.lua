...
return {
  manifest_version = 102,
  manifest_id = "manifest-v102",
  source_ref = "beta",
  hash_algo = "crc32",

  base_files = {
  { path = "installer_http.lua", size_bytes = 4688, hash = "ea6f7420", always=true},
  { path = "installer_main.lua", size_bytes = 27091, hash = "095e8684", always=true},
  ...
  { path = "core/remote_update.lua", size_bytes = 3014, hash = "edd2a461"},
  ...
  roles = {
    ...
    { path = "master/monitor_sessions.lua", size_bytes = 6439, hash = "ba9c6810", required_for={"MASTER"}},
    ...
    { path = "master/runtime_ops_profile.lua", size_bytes = 6818, hash = "665b6524", required_for={"MASTER"}},
    ...
    { path = "nodes/rt/command_handler.lua", size_bytes = 12011, hash = "1aef3bff", required_for={"RT"}},
    ...
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 32006, hash = "f30d18c8", required_for={"RT"}},
    ...
    { path = "nodes/energy/main.lua", size_bytes = 25378, hash = "81649dbd", required_for={"ENERGY"}},
    ...
    { path = "nodes/water/main.lua", size_bytes = 22727, hash = "2505cac0", required_for={"WATER"}},
    ...
    { path = "nodes/fuel/logistics_router.lua", size_bytes = 17341, hash = "bc80b061", required_for={"FUEL","REPROCESSING"}},
  ...
  { path = "nodes/reprocessor/feed_router.lua", size_bytes = 7060, hash = "475ecc96"},
    ...
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 36428, hash = "4bdb62da", required_for={"LOG"}},
    },
    shared_support = {
    { path = "nodes/support/command_handler.lua", size_bytes = 5286, hash = "58ef1562", required_for={"WATER", "FUEL", "REPROCESSING"}},
