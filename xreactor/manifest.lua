...
return {
  manifest_version = 465,
  manifest_id = "manifest-v465",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "c8d1da71", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 60152, hash = "0c567b48", required_for={"RT"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 27266, hash = "b095dae9", required_for={"WATER"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 21019, hash = "9785f61a", required_for={"VALVE"} },
    },
    log = {
