...
return {
  ...
  roles = {
    ...
    rt = {
    { path = "adapters/reactor.lua", size_bytes = 17672, hash = "b2f8ed4a", required_for={"RT"} },
    ...
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 26386, hash = "0738f008", required_for={"RT"} },
