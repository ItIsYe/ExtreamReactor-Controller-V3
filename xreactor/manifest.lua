...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "e35a0cbc", always = true },
  ...
  roles = {
    ...
    { path = "master/runtime_ops_rt.lua", size_bytes = 17778, hash = "0cf11fb4", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 52691, hash = "5d5c3350", required_for={"RT"} },
    ...
    { path = "nodes/rt/state_handlers.lua", size_bytes = 9749, hash = "f96b8d74", required_for={"RT"} },
    ...
    { path = "adapters/logistical_sorter.lua", size_bytes = 3795, hash = "f4cc97ca", required_for={"REPROCESSING"} },
    ...
    reprocessing = {
    { path = "nodes/reprocessor/color_router_ui.lua", size_bytes = 16871, hash = "aa230a6e", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/config.lua", size_bytes = 3992, hash = "ee397604", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/config_normalizer.lua", size_bytes = 2955, hash = "2e70a592", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/feed_router.lua", size_bytes = 15364, hash = "1705bcdc", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/main.lua", size_bytes = 25383, hash = "3f80a780", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/ui_pages.lua", size_bytes = 12284, hash = "f3722d21", required_for={"REPROCESSING"} },
