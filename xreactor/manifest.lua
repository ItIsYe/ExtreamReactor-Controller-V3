return {
  ...
  base_files = {
      ...
      { path = "release.lua", size_bytes = 340, hash = "9a25d965", always = true },
  ...
  roles = {
    ...
    energy = {
      ...
      { path = "nodes/energy/main.lua", size_bytes = 53014, hash = "a9be3aba", required_for = { "ENERGY" } },
      { path = "adapters/energy_storage.lua", size_bytes = 3220, hash = "65c983a9" },
      { path = "adapters/induction_matrix.lua", size_bytes = 6424, hash = "496c50d4" },
    },
    water = {
