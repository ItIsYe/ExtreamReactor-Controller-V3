return {
  ...
  base_files = {
      ...
      { path = "installer_main.lua", size_bytes = 11535, hash = "d93e1238", always = true },
      { path = "installer_manifest.lua", size_bytes = 2595, hash = "4b3f2844", always = true },
      { path = "installer_stage.lua", size_bytes = 4213, hash = "d17bc01d", always = true },
      { path = "installer_startup.lua", size_bytes = 845, hash = "6939c5e9", always = true },
      { path = "installer_storage.lua", size_bytes = 8116, hash = "fb4435f6", always = true },
      { path = "release.lua", size_bytes = 349, hash = "6a444533", always = true },
      ...
      { path = "services/matrix_sampling_service.lua", size_bytes = 568, hash = "628f7f61" },
  ...
  roles = {
    master = {
      ...
      { path = "master/main.lua", size_bytes = 17572, hash = "0109aa12", required_for = { "MASTER" } },
      { path = "master/message_handlers.lua", size_bytes = 5813, hash = "11c7afb4" },
      { path = "master/profiles.lua", size_bytes = 164, hash = "9068a725" },
      { path = "master/rt_sync.lua", size_bytes = 2317, hash = "88f1a944" },
      { path = "master/runtime_context.lua", size_bytes = 4776, hash = "ee8f1b94" },
      { path = "master/startup_sequencer.lua", size_bytes = 8356, hash = "45f27ed8" },
      { path = "master/ui_controller.lua", size_bytes = 14638, hash = "7b067f3c" },
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 22401, hash = "53977dd1" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 79150, hash = "77e0785d", required_for = { "RT" } },
    ...
    energy = {
      ...
      { path = "nodes/energy/config.lua", size_bytes = 7214, hash = "a925edf5" },
      ...
      { path = "nodes/energy/main.lua", size_bytes = 22839, hash = "ede91c6a", required_for = { "ENERGY" } },
      { path = "nodes/energy/runtime_context.lua", size_bytes = 1914, hash = "447ea770" },
      { path = "nodes/energy/status_payload.lua", size_bytes = 6456, hash = "b011224a" },
