return {
  ...
  roles = {
    master = {
      ...
      { path = "master/main.lua", size_bytes = 20849, hash = "17646aaa", required_for = { "MASTER" } },
      { path = "master/message_handlers.lua", size_bytes = 8447, hash = "a29920d6" },
      { path = "master/profiles.lua", size_bytes = 164, hash = "9068a725" },
      { path = "master/rt_sync.lua", size_bytes = 7193, hash = "755a07f5" },
      ...
      { path = "master/ui_controller.lua", size_bytes = 16248, hash = "b09f4f14" },
      ...
      { path = "master/ui/rt_dashboard.lua", size_bytes = 3220, hash = "7d5d15b0" },
