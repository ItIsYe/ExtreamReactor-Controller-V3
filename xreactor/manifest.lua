-- xreactor/manifest.lua -- manifest-v43
return {
  manifest_version = 43,
  ...
  { path = "release.lua", size_bytes = 345, hash = "4320aae9", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 96572, hash = "f06dbb33", required_for={"RT"} },
