...
return {
  manifest_version = 436,
  manifest_id = "manifest-v436",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "0e760f73", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 42913, hash = "850aeeb3", required_for={"RT"} },
