...
return {
  ...
  { path = "release.lua", size_bytes = 273, hash = "cb808612", always=true },
  ...
  { path = "shared/constants.lua", size_bytes = 3098, hash = "0c5fb837", always=true },
    { path = "core/mockup_ui.lua", size_bytes = 9963, hash = "new", always=true },
  ...
  { path = "core/logger.lua", size_bytes = 31336, hash = "2f3ede51" },
  { path = "core/monitor_manager.lua", size_bytes = 10306, hash = "7bdff373" },
  ...
  { path = "core/state_machine.lua", size_bytes = 842, hash = "4ae6c19c" },
    { path = "core/startup_report.lua", size_bytes = 4090, hash = "new", always=true },
  ...
  { path = "core/ui_router.lua", size_bytes = 7333, hash = "e626dd67" },
  ...
  { path = "shared/colors.lua", size_bytes = 593, hash = "445d12af" },
  ...
  roles = {
    ...
    { path = "master/runtime_loop.lua", size_bytes = 13894, hash = "fc4ec810", required_for={"MASTER"} },
    { path = "master/runtime_ops_monitor.lua", size_bytes = 2634, hash = "8454a2a2", required_for={"MASTER"} },
    { path = "master/runtime_ops_profile.lua", size_bytes = 15968, hash = "4dd38e37", required_for={"MASTER"} },
    ...
    { path = "master/ui/multiview.lua", size_bytes = 17067, hash = "89fd7db8", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/command_handler.lua", size_bytes = 11461, hash = "13dd99f8", required_for={"RT"} },
    { path = "nodes/rt/reactor_control.lua", size_bytes = 35139, hash = "746286eb", required_for={"RT"} },
    { path = "nodes/rt/turbine_control.lua", size_bytes = 42947, hash = "02f343b9", required_for={"RT"} },
    ...
    { path = "nodes/rt/config.lua", size_bytes = 4023, hash = "5abc9f12", required_for={"RT"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 38249, hash = "ac098c39", required_for={"RT"} },
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 27375, hash = "fa733934", required_for={"RT"} },
    { path = "nodes/rt/monitor_ui.lua", size_bytes = 16319, hash = "159857c2", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 19526, hash = "78e2da3f", required_for={"ENERGY"} },
    ...
    { path = "nodes/energy/ui_pages.lua", size_bytes = 18429, hash = "ccc2edb6", required_for={"ENERGY"} },
    },
    water = {
    ...
    { path = "nodes/water/main.lua", size_bytes = 18866, hash = "dd1236f0", required_for={"WATER"} },
    { path = "nodes/water/ui_pages.lua", size_bytes = 10862, hash = "new", required_for={"WATER"} },
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 16873, hash = "181bc955", required_for={"FUEL"} },
    { path = "nodes/fuel/ui_pages.lua", size_bytes = 11871, hash = "new", required_for={"FUEL"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 18404, hash = "5613b787", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/ui_pages.lua", size_bytes = 11071, hash = "new", required_for={"REPROCESSING"} },
    { path = "nodes/reprocessor/role_descriptor.lua", size_bytes = 177, hash = "3a1d8dc9", required_for={"REPROCESSING"} },
    },
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 37962, hash = "448e1339", required_for={"LOG"} },
    ...
    { path = "nodes/support/ui_pages.lua", size_bytes = 5346, hash = "e9f1a7c9", required_for={"WATER", "FUEL", "REPROCESSING", "ENERGY", "RT", "MASTER"} },
    },
  },
