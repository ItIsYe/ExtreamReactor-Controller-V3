return {
  ...
  base_files = {
      ...
      { path = "installer_main.lua", size_bytes = 15820, hash = "27360e62", always = true },
      ...
      { path = "installer_storage.lua", size_bytes = 8422, hash = "2c390573", always = true },
      { path = "release.lua", size_bytes = 385, hash = "2402f935", always = true },
  ...
  roles = {
    master = {
      ...
      { path = "master/main.lua", size_bytes = 19288, hash = "4144d613", required_for = { "MASTER" } },
    ...
    energy = {
      ...
      { path = "nodes/energy/main.lua", size_bytes = 22886, hash = "78b9e726", required_for = { "ENERGY" } },
