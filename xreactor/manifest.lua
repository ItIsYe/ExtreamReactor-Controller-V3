return {
  ...
  base_files = {
      ...
      { path = "release.lua", size_bytes = 343, hash = "23a8e1e7", always = true },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/config_normalizer.lua", size_bytes = 16036, hash = "dbec685f" },
      { path = "nodes/rt/config.lua", size_bytes = 6403, hash = "1c518411" },
      ...
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 21346, hash = "3b2b8514" },
      { path = "nodes/rt/flow_apply_helpers.lua", size_bytes = 8113, hash = "57d5a773" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 99063, hash = "df460eef", required_for = { "RT" } },
      { path = "nodes/rt/state_handlers.lua", size_bytes = 4329, hash = "34ef2d43" },
      { path = "adapters/reactor.lua", size_bytes = 16092, hash = "f780d967" },
      { path = "adapters/turbine.lua", size_bytes = 3871, hash = "a9e924f3" },
      { path = "core/control_rails.lua", size_bytes = 8017, hash = "01c1a770" },
      { path = "core/fluid.lua", size_bytes = 3949, hash = "03ac2ce5" },
      { path = "core/turbine_ctrl.lua", size_bytes = 2907, hash = "4400bab4" },
      { path = "core/turbine_regulator.lua", size_bytes = 16380, hash = "8ce59b23" },
    },
    energy = {
