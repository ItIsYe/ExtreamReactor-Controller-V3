...
return {
  manifest_version = 277,
  manifest_id = "manifest-v277",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  roles = {
    ...
    { path = "master/init_runtime.lua", size_bytes = 7590, hash = "eba62959", required_for={"MASTER"} },
    ...
    { path = "master/runtime_loop.lua", size_bytes = 11263, hash = "fc4ec810", required_for={"MASTER"} },
    ...
    { path = "master/ui_controller.lua", size_bytes = 40782, hash = "89b29492", required_for={"MASTER"} },
