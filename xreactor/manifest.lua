...
return {
  manifest_version = 458,
  manifest_id = "manifest-v458",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "installer/stage.lua", size_bytes = 8358, hash = "82adbf99", always=true },
  ...
  { path = "release.lua", size_bytes = 273, hash = "34d6d792", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 57080, hash = "0acff800", required_for={"RT"} },
    { path = "nodes/rt/module_lifecycle.lua", size_bytes = 27375, hash = "81be3889", required_for={"RT"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 31348, hash = "2b67c551", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 18926, hash = "87850bec", required_for={"VALVE"} },
    },
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 57110, hash = "cfc94887", required_for={"LOG"} },
