...
return {
  manifest_version = 732,
  manifest_id = "manifest-v732",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "bd770090", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 15428, hash = "0a25652f", required_for={"RT"} },
