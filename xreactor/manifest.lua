...
return {
  ...
  { path = "release.lua", size_bytes = 348, hash = "940c1f00", always=true},
  { path = "start.lua", size_bytes = 11016, hash = "d28a7c0d", always=true},
  ...
  { path = "core/logger.lua", size_bytes = 31227, hash = "b82648cd"},
  ...
  roles = {
    ...
    { path = "nodes/energy/main.lua", size_bytes = 25503, hash = "0fd2908d", required_for={"ENERGY"}},
