...
return {
  ...
  roles = {
    ...
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 29074, hash = "1b752d4a", required_for={"LOG"} },
    },
    shared_support = {
    ...
    { path = "nodes/support/ui_pages.lua", size_bytes = 5097, hash = "e9f1a7c9", required_for={"WATER", "FUEL", "REPROCESSING"} },
    },
  },
