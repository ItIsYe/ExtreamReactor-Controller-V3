return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 9564, hash = "b47c6fa9", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 6118, hash = "9ae31b6e" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 2803, hash = "3a1b2e69" },
      { path = "master/ui/multiview.lua", size_bytes = 4430, hash = "b3b831d3" },
      { path = "master/ui/overview.lua", size_bytes = 5613, hash = "23564e35" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 3157, hash = "29296848" },
      { path = "master/ui/widgets.lua", size_bytes = 4093, hash = "8f7b3ebe" },
