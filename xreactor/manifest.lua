...
return {
  manifest_version = 506,
  manifest_id = "manifest-v506",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "1c35dcc0", always = true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 25010, hash = "6af3b052", required_for={"FUEL"}},
    ...
    { path = "nodes/fuel/ui_completion.lua", size_bytes = 17190, hash = "5630f9d4", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/router_ui_responsive.lua", size_bytes = 11436, hash = "8ccea220", required_for={"FUEL"} },
    },
    reprocessing = {
