return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 29521, hash = "e8b72552" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 97517, hash = "565f7335", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 10174, hash = "b75bd586" },
    },
    energy = {
