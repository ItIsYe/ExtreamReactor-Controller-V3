return {
  ...
  roles = {
    master = {
      ...
      { path = "master/ui_controller.lua", size_bytes = 5511, hash = "70542971" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 2273, hash = "e0025d06" },
      { path = "master/ui/multiview.lua", size_bytes = 3064, hash = "20d442df" },
      { path = "master/ui/overview.lua", size_bytes = 4726, hash = "a245184b" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 2334, hash = "28274500" },
      { path = "master/ui/widgets.lua", size_bytes = 2164, hash = "aa3d56cb" },
