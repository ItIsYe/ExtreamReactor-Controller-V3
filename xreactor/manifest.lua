...
return {
  manifest_version = 394,
  manifest_id = "manifest-v394",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "ee8442a2", always=true },
  ...
  { path = "core/ui_router.lua", size_bytes = 14925, hash = "493462bd" },
  ...
  roles = {
    ...
    { path = "master/runtime_loop.lua", size_bytes = 13979, hash = "88b1e913", required_for={"MASTER"} },
    ...
    { path = "master/ui/multiview.lua", size_bytes = 18994, hash = "7ab20080", required_for={"MASTER"} },
    ...
    { path = "master/ui_controller.lua", size_bytes = 45750, hash = "ad019d28", required_for={"MASTER"} },
    ...
    { path = "nodes/rt/turbine_control.lua", size_bytes = 42947, hash = "17de6939", required_for={"RT"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 38249, hash = "e3fb0a68", required_for={"RT"} },
    ...
    { path = "nodes/energy/main.lua", size_bytes = 19526, hash = "9c5f9614", required_for={"ENERGY"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 18889, hash = "73ac2cd5", required_for={"WATER"} },
    ...
    { path = "nodes/fuel/main.lua", size_bytes = 18386, hash = "50d996a4", required_for={"FUEL"} },
    { path = "nodes/fuel/status_snapshot.lua", size_bytes = 4110, hash = "7b08a0e9", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 9743, hash = "d5735038", required_for={"FUEL"} },
    { path = "nodes/fuel/storage.lua", size_bytes = 2275, hash = "370bf2fa", required_for={"FUEL"} },
    { path = "nodes/fuel/ui_pages.lua", size_bytes = 14121, hash = "49a7d99f", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 20789, hash = "dd5fd3bc", required_for={"FUEL","REPROCESSING"} },
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 18427, hash = "6ee59479", required_for={"REPROCESSING"} },
    ...
    { path = "nodes/valve/main.lua", size_bytes = 7624, hash = "fc5dc309", required_for={"VALVE"} },
    },
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 47989, hash = "2a722dec", required_for={"LOG"} },
