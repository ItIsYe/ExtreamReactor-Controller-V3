return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 15832, hash = "f887bbb0" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 87930, hash = "d398a0f7", required_for = { "RT" } },
      ...
      { path = "core/turbine_ctrl.lua", size_bytes = 1839, hash = "affff755" },
      { path = "core/turbine_regulator.lua", size_bytes = 2973, hash = "0acb1626" },
    },
    energy = {
