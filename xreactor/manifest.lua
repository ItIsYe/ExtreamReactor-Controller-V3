return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 13520, hash = "0cadb869", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 12278, hash = "0537ac51" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 4896, hash = "0be23399" },
      { path = "master/ui/multiview.lua", size_bytes = 4738, hash = "23f1c22c" },
      { path = "master/ui/overview.lua", size_bytes = 8908, hash = "3f2c817b" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 4571, hash = "2f33f40c" },
