...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "6f26e197", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 51436, hash = "47c32800", required_for={"RT"} },
    ...
    { path = "nodes/fuel/router_ui.lua", size_bytes = 24654, hash = "6a2a4b93", required_for={"FUEL"} },
    ...
    reprocessing = {
    { path = "nodes/reprocessor/color_router_ui.lua", size_bytes = 13385, hash = "43c0444f", required_for={"REPROCESSING"} },
