...
return {
  manifest_version = 556,
  manifest_id = "manifest-v556",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "installer/init.lua", size_bytes = 30545, hash = "27f01f0e", always = true },
  ...
  { path = "release.lua", size_bytes = 345, hash = "199bf76d", always = true },
