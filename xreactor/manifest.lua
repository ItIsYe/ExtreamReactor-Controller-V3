...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "43351279", always = true },
  ...
  roles = {
    ...
    reprocessing = {
    { path = "nodes/reprocessor/color_router_ui.lua", size_bytes = 17836, hash = "e3bb6e94", required_for={"REPROCESSING"} },
