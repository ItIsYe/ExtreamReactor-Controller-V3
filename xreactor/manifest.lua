return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 12752, hash = "5136573c", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 10194, hash = "fafbde54" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 4700, hash = "e580c7ab" },
      ...
      { path = "master/ui/rt_dashboard.lua", size_bytes = 4578, hash = "5d850656" },
