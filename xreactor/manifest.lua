return {
  ...
  base_files = {
      ...
      { path = "core/logger.lua", size_bytes = 24167, hash = "55e61c19" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 91855, hash = "43ce65c1", required_for = { "RT" } },
      ...
      { path = "core/turbine_regulator.lua", size_bytes = 5080, hash = "93cf2e18" },
    },
    energy = {
