...
return {
  manifest_version = 383,
  manifest_id = "manifest-v383",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "d5b8071c", always=true },
  ...
  roles = {
    ...
    log = {
    { path = "nodes/log_collector/main.lua", size_bytes = 42880, hash = "0c0cba35", required_for={"LOG"} },
