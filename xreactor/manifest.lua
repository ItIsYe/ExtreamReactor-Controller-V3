...
return {
  manifest_version = 210,
  manifest_id = "manifest-v210",
  source_ref = "beta",
  hash_algo = "none",
  ...
  { path = "release.lua", size_bytes = 273, hash = "09909bc8", always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true, always=true},
