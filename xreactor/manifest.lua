return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 17375, hash = "3fe9decc" },
      ...
      { path = "master/ui_controller.lua", size_bytes = 21162, hash = "de07bb9f" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 6952, hash = "d5c284dd" },
      { path = "master/ui/multiview.lua", size_bytes = 5959, hash = "f88a92e2" },
      { path = "master/ui/overview.lua", size_bytes = 10569, hash = "b6c966d4" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 7194, hash = "ab99457d" },
