...
return {
  ...
  roles = {
    ...
    { path = "master/runtime_ops_profile.lua", size_bytes = 11031, hash = "0fc5232c", required_for={"MASTER"}},
    ...
    { path = "nodes/rt/capacity_cache.lua", size_bytes = 2988, hash = "810c6a20", required_for={"RT"}},
    ...
    { path = "nodes/energy/main.lua", size_bytes = 25287, hash = "614de5f6", required_for={"ENERGY"}},
