...
return {
  manifest_version = 462,
  manifest_id = "manifest-v462",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "9607cab8", always=true },
  ...
  roles = {
    ...
    energy = {
    { path = "nodes/energy/heartbeat.lua", size_bytes = 5711, hash = "9b6663fb", required_for={"ENERGY"} },
