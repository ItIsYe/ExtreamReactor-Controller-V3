...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "a44cb9df", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/config.lua", size_bytes = 7525, hash = "f2d1e5db", required_for={"RT"} },
    ...
    { path = "nodes/rt/main.lua", size_bytes = 64633, hash = "aefdc19c", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_capacity.lua", size_bytes = 15933, hash = "fb9231aa", required_for={"RT"} },
    { path = "nodes/rt/rt2_command_handler.lua", size_bytes = 5199, hash = "d8141714", required_for={"RT"} },
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 16116, hash = "d35621f2", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 9401, hash = "514235cf", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_unit.lua", size_bytes = 7875, hash = "911265cb", required_for={"RT"} },
    { path = "nodes/rt/rt2_tuning.lua", size_bytes = 11862, hash = "f753ab2a", required_for={"RT"} },
    { path = "nodes/rt/rt2_turbine.lua", size_bytes = 14895, hash = "0a6cd76b", required_for={"RT"} },
