return {
  ...
  roles = {
    master = {
      ...
      { path = "master/ui/energy.lua", size_bytes = 2406, hash = "bd19b2f9" },
      { path = "master/ui/multiview.lua", size_bytes = 3082, hash = "a41d3f91" },
      { path = "master/ui/overview.lua", size_bytes = 4908, hash = "f9e4dae1" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 2851, hash = "9cc36f2c" },
      { path = "master/ui/widgets.lua", size_bytes = 3441, hash = "8b13c2f0" },
