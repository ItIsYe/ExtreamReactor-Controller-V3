return {
  ...
  roles = {
    master = {
      ...
      { path = "master/runtime_loop.lua", size_bytes = 15105, hash = "04d1762b" },
      ...
      { path = "master/init_runtime.lua", size_bytes = 6177, hash = "218c8205", required_for = { "MASTER" } },
      ...
      { path = "master/ui_controller.lua", size_bytes = 19199, hash = "e8672dde" },
      { path = "master/ui/alarms.lua", size_bytes = 1345, hash = "0a381649" },
      { path = "master/ui/alerts.lua", size_bytes = 25335, hash = "746207f8" },
      { path = "master/ui/energy.lua", size_bytes = 6776, hash = "7039a658" },
      { path = "master/ui/multiview.lua", size_bytes = 5908, hash = "60bdaef4" },
      { path = "master/ui/overview.lua", size_bytes = 10407, hash = "baa95df1" },
      { path = "master/ui/resources.lua", size_bytes = 5634, hash = "3c3f86d2" },
      { path = "master/ui/rt_dashboard.lua", size_bytes = 6121, hash = "49020191" },
