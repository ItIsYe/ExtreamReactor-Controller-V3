...
return {
  manifest_version = 377,
  manifest_id = "manifest-v377",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "1fadcf03", always=true },
  ...
  { path = "core/ui_router.lua", size_bytes = 7333, hash = "59f6ef44" },
  ...
  roles = {
    ...
    { path = "nodes/support/ui_pages.lua", size_bytes = 6785, hash = "389f68f6", required_for={"WATER", "FUEL", "REPROCESSING", "ENERGY", "RT", "MASTER"} },
    },
  },
