...
return {
  manifest_version = 459,
  manifest_id = "manifest-v459",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 273, hash = "6e5a66ca", always=true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 58063, hash = "590d4372", required_for={"RT"} },
