...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "f9a8d5b2", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/rt2_adapter.lua", size_bytes = 4481, hash = "415f1979", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 8396, hash = "913420a5", required_for={"RT"} },
