...
return {
  ...
  { path = "release.lua", size_bytes = 345, hash = "4569e658", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 64026, hash = "7edcb987", required_for={"RT"} },
    ...
    { path = "nodes/rt/rt2_engine.lua", size_bytes = 14552, hash = "4cd3e791", required_for={"RT"} },
    { path = "nodes/rt/rt2_master_link.lua", size_bytes = 1555, hash = "aa8589ad", required_for={"RT"} },
    { path = "nodes/rt/rt2_orchestrator.lua", size_bytes = 9638, hash = "d46495ce", required_for={"RT"} },
