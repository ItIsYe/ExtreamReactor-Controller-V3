-- xreactor/manifest.lua -- manifest-v532
return {
  manifest_version = 532,
  manifest_id = "manifest-v532",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  base_files = {
    ...
    { path = "core/comms.lua", size_bytes = 34373, hash = "1783b74b" },
    ...
    { path = "core/protocol.lua", size_bytes = 17207, hash = "86c402bd" },
    ...
    { path = "core/utils.lua", size_bytes = 23275, hash = "201e8d1f" },
    { path = "core/auto_update.lua", size_bytes = 4483, hash = "dbbc4dd5" },
    { path = "core/remote_update.lua", size_bytes = 9024, hash = "cf2da242" },
  ...
  roles = {
    master = {
      ...
      { path = "master/message_handlers.lua", size_bytes = 30250, hash = "e9e379dd", required_for={"MASTER"} },
      ...
      { path = "optional/pocket_query_handler.lua", size_bytes = 7153, hash = "495920be", optional=true, feature="pocket_query", required_for={"MASTER"} },
      { path = "optional/pocket_client.lua", size_bytes = 11020, hash = "56fe39d7", optional=true, feature="pocket_client", required_for={} },
    ...
    fuel = {
      ...
      { path = "nodes/fuel/main.lua", size_bytes = 23651, hash = "0db006df", required_for={"FUEL"} },
      ...
      { path = "nodes/fuel/fuel_status_network.lua", size_bytes = 3616, hash = "2086b4ed", required_for={"FUEL"} },
    ...
    reprocessing = {
      ...
      { path = "nodes/valve/main.lua", size_bytes = 21085, hash = "dac1db44", required_for={"VALVE"} },
    },

    log = {
      { path = "nodes/log_collector/main.lua", size_bytes = 60942, hash = "e81cf22c", required_for={"LOG"} },
