return {
  ...
  hash_algo = "crc32",
  base_files = {
      { path = "adapters/monitor.lua", size_bytes = 4228, hash = "d63d1781" },
      ...
      { path = "core/ui.lua", size_bytes = 10445, hash = "a6aac9fc" },
  ...
  roles = {
    ...
    rt = {
      ...
      { path = "nodes/rt/monitor_ui.lua", size_bytes = 14428, hash = "8e8c600d" },
      { path = "nodes/rt/module_lifecycle.lua", size_bytes = 10012, hash = "315dc2d0" },
      ...
      { path = "nodes/rt/main.lua", size_bytes = 81193, hash = "34ea9a6b", required_for = { "RT" } },
      { path = "nodes/rt/state_handlers.lua", size_bytes = 4062, hash = "4afb2a66" },
      { path = "adapters/reactor.lua", size_bytes = 12823, hash = "c3feb77d" },
