...
return {
  ...
  { path = "release.lua" , always = true, size_bytes = 345, hash = "48ffab7b" },
  ...
  roles = {
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 8490, hash = "ae3bfe98", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 50818, hash = "63190671", required_for={"FUEL","REPROCESSING","WATER"} },
