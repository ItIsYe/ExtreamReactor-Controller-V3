return {
  ...
  roles = {
    master = {
      ...
      { path = "master/main.lua", size_bytes = 31672, hash = "6f701e5c", required_for = { "MASTER" } },
      { path = "master/message_handlers.lua", size_bytes = 9942, hash = "1e87ae97" },
      { path = "master/profiles.lua", size_bytes = 164, hash = "9068a725" },
      { path = "master/rt_sync.lua", size_bytes = 12543, hash = "d8aa3425" },
    ...
    rt = {
      ...
      { path = "nodes/rt/main.lua", size_bytes = 85030, hash = "a24c0409", required_for = { "RT" } },
