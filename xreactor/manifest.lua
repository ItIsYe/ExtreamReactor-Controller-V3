...
return {
  manifest_version = 621,
  manifest_id = "manifest-v621",
  source_ref = "beta",
  hash_algo = "crc32",
  ...
  { path = "release.lua", size_bytes = 345, hash = "f3f8e568", always = true },
  ...
  roles = {
    ...
    { path = "nodes/rt/main.lua", size_bytes = 49636, hash = "8b9eef70", required_for={"RT"} },
    ...
    { path = "nodes/water/main.lua", size_bytes = 25518, hash = "8edfc8a3", required_for={"WATER"} },
    ...
    fuel = {
    { path = "nodes/fuel/config.lua", size_bytes = 6792, hash = "483e8953", required_for={"FUEL"} },
    { path = "nodes/fuel/config_normalizer.lua", size_bytes = 6736, hash = "946d3161", required_for={"FUEL"} },
    { path = "nodes/fuel/main.lua", size_bytes = 22453, hash = "feae7e86", required_for={"FUEL"} },
    { path = "nodes/fuel/status_snapshot.lua", size_bytes = 4662, hash = "cc71fd01", required_for={"FUEL"} },
    { path = "nodes/fuel/operational_summary.lua", size_bytes = 8277, hash = "3fb24d2b", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/monitor_ui.lua", size_bytes = 12742, hash = "89d741f9", required_for={"FUEL"} },
    { path = "nodes/fuel/ui_completion.lua", size_bytes = 18717, hash = "3d231619", required_for={"FUEL"} },
    ...
    { path = "nodes/fuel/logistics_router.lua", size_bytes = 35624, hash = "774bb4f1", required_for={"FUEL"} },
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 45563, hash = "4d5b851a", required_for={"FUEL","REPROCESSING"} },
    { path = "nodes/fuel/router_ui.lua", size_bytes = 38047, hash = "2586fe76", required_for={"FUEL","REPROCESSING"} },
    },
    reprocessing = {
    ...
    { path = "nodes/reprocessor/main.lua", size_bytes = 27430, hash = "0842e664", required_for={"REPROCESSING"} },
