...
return {
  ...
  { path = "release.lua", size_bytes = 273, hash = "5dd36056", always=true },
  ...
  roles = {
    ...
    { path = "nodes/fuel/redstone_router.lua", size_bytes = 38048, hash = "d6b08602", required_for={"FUEL","REPROCESSING","WATER"} },
