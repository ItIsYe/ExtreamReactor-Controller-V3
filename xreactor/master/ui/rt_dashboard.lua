...
local function render_rt_card(mon, x, y, w, rt)
  ...
  ui.text(mon, box.x, box.y + 10, widgets.fit("Queue: " .. tostring(rt.queue_state or "idle") .. " | Step: " .. tostring(rt.queue_step or "-"), box.w), colors.get("muted"), colors.get("background"))
end
