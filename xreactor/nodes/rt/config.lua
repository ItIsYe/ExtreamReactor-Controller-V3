...
return {
  ...
  rails = {
    ...
    -- individueller Pro-Reaktor-Regelung (>1 Reaktor pro RT-Node, siehe
    -- reactor_control.lua controlReactorsIndividually()). Ueber den
    -- Config-Editor am Master per Touch aenderbar und persistent.
