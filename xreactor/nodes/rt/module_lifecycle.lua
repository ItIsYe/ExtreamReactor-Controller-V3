...
function M.process_startup(ctx)
  ...
  -- "now" und "module.start_time" sind beide os.epoch("utc") in
  -- Millisekunden -- die Rampendauer muss deshalb ebenfalls in
  -- Millisekunden vorliegen, sonst erreicht der Fortschritt fast sofort
  -- 100% (siehe ctx.ramp_duration_ms in main.lua).
