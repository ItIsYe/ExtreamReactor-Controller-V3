...
local CONFIG = {
  ...
  DEFAULT_MATRIX_METRIC_POLL_INTERVAL = 8.0, -- erhöht: seltener pollen reduziert Event-Loop-Blockaden -- Seconds between expensive matrix energy metric reads.
  DEFAULT_MATRIX_METRIC_CALL_BUDGET = 2, -- reduziert: weniger Calls pro Tick, kein langer Block -- Max expensive matrix metric calls per status build tick.
  DEFAULT_MATRIX_METRIC_TIME_BUDGET_MS = 8000, -- erhöht: grosse Matrizen brauchen 5+ Sekunden -- Max cumulative time spent on expensive matrix metric reads per status build.
  ...
  DEFAULT_MATRIX_COMPONENT_TIME_BUDGET_MS = 3000, -- erhöht fuer grosse Matrizen -- Max time spent on matrix component calls per tick.
  ...
  DEFAULT_COMMS_PEER_TIMEOUT = 30.0, -- erhöht: Matrix-Polling kann 5+ Sekunden blockieren -- Seconds before marking peer down.
  DEFAULT_COMMS_PEER_DOWN_GRACE = 8.0, -- erhöht: Puffer fuer langsame Matrix-Abfragen -- Extra stale time before peer-down transition.
