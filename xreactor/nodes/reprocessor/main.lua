...
local CONFIG = {
  ...
  BOOTSTRAP_LOG_PATH = nil, -- Optional override for loader log file (default: /xreactor/logs/loader_reprocessor.log).
...
local function render_monitor()
  ...
  for _, peer in pairs(peers) do
    if peer.role == constants.roles.MASTER then
      ...
      master_age = peer.age and string.format("%ds", math.floor(peer.age)) or "n/a"
      break
    end
  end
