...
6. **Rod-Regler Min-Clamp / 70%-Power-Cap**: Default prüfen (`autonom.regulator_min_rods = 30`); Automatik darf nie unter `30` rods gehen (`100% rods = 0% Leistung`, `0% rods = 100% Leistung`), Log muss `ROD_TARGET_CLAMPED_BY_CONFIG_MIN` zeigen.
