...
- The automatic reactor rod regulator now supports explicit config clamps:
  - `autonom.regulator_min_rods` (default `50`; this equals the default `rails.reactor_rods.min`)
  - `autonom.regulator_max_rods` (default `100`; this equals the default `rails.reactor_rods.max`)
