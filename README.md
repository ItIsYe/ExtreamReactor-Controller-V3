...
- Normalizes induction component APIs (`getInstalledCells` / `getInstalledProviders` variants that return lists, maps, nested result tables, boolean+payload tuples, strings, or numbers) into stable numeric counts.
