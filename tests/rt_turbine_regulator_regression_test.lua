...
assert_eq(ok,true,'RUNNING'); assert_eq(reason,'STATE_OK','RUNNING reason')
assert_eq(regulator.should_regulate_module_state('OFF'),true,'OFF compat-stub')
assert_eq(regulator.should_regulate_module_state('STARTING'),true,'STARTING compat-stub')
assert_eq(regulator.should_regulate_module_state('ERROR'),true,'ERROR compat-stub')
