...
assert_eq(r.transition, 'REQUESTED', 'transition must be REQUESTED')
assert_eq(get_t(), constants.node_states.OFF, 'expected transition to OFF for shutdown workflow')
